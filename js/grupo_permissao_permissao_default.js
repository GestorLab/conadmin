			...
			if(xmlhttp.readyState == 4){ 
				if(xmlhttp.status == 200){
					...
					if(xmlhttp.responseText == 'false'){
						...
						listar_grupo_permissao(IdGrupoPermissao)
						// Fim de Carregando
						carregando(false);
					}else{
...
function busca_operacao(){
	...
	if (window.XMLHttpRequest) { // Mozilla, Safari,...
   	...
   	url = "xml/usuario_operacao.php?Login="+Login+"&IdLoja="+IdLoja+"&IdModulo="+IdModulo;
	xmlhttp.open("GET", url,true);
...
function busca_sub_operacao_permissoes(){
	...
	if (window.XMLHttpRequest) { // Mozilla, Safari,...
   	...
   	url = "xml/grupo_permissao_sub_operacao.php?IdGrupoPermissao="+IdGrupoPermissao+"&IdLoja="+IdLoja+"&IdModulo="+IdModulo+"&IdOperacao="+IdOperacao;
	xmlhttp.open("GET", url,true);
...
function busca_sub_operacao_permissoes_dados(){
	...
	if (window.XMLHttpRequest) { // Mozilla, Safari,...
   	...
   	url = "xml/grupo_permissao_sub_operacao.php?IdGrupoPermissao="+IdGrupoPermissao+"&IdLoja="+IdLoja+"&IdModulo="+IdModulo+"&IdOperacao="+IdOperacao+"&IdSubOperacao="+IdSubOperacao;
	xmlhttp.open("GET", url,true);
...
function quadro_permissao(Acao){
	...
	if(IdGrupoPermissao == ""){			return false;	}
