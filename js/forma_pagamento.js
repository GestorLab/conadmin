	function excluir(IdFormaPagamento){
		if(excluir_registro() == true){
		    ...
		    //    	xmlhttp.overrideMimeType('text/xml');
   			...
   			url = "files/excluir/excluir_forma_pagamento.php?IdFormaPagamento="+IdFormaPagamento;
	...
	function validar(){
		...
		if(document.formulario.LocalFinalizador.value==''){
			mensagens(1);
			document.formulario.LocalFinalizador.focus();
			return false;
		}
		return true;
	}
