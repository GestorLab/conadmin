<?
	...
	while($lin = @mysql_fetch_array($res)){
		...
		$sql = "update ContaReceber set IdPessoa='$lin[IdPessoa]',  IdPessoaEndereco='$lin[IdEnderecoCobrancaDefault]' where IdLoja='$lin[IdLoja]' and IdContaReceber='$lin[IdContaReceber]'";
