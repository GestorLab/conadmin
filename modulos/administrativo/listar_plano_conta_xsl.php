		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('IdAcessoRapido')">Acesso Rápido <?=compara($localOrdem,"IdAcessoRapido",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('Tipo')">Tipo <?=compara($localOrdem,"Tipo",$ImgOrdernarASC,'')?></a>
					</td>
					<td style='width: 90px'>
						<a href="javascript:filtro_ordenar('AcaoContabil')">Ação Contábil <?=compara($localOrdem,"AcaoContabil",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='bt_lista' />
				</tr>
