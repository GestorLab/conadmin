<?
	...
	$localOcultaLocalCob			= $_GET['OcultarLocalCob'];
	$localOcultaOcultarNumRec		= $_GET['OcultarNumRec'];
...
<html>	
	...
	<body  onLoad="ativaNome('Nota Fiscal')">
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<?
						if($localOcultaOcultarNumRec == 2){
							echo "<td>
									<a href=\"javascript:filtro_ordenar('IdContaReceber','number')\">Nº Conta R.".compara($localOrdem,"IdContaReceber",$ImgOrdernarASC,'')."</a>
								</td>";
						}
					?>
					<?
					...
					<td>
						<a href="javascript:filtro_ordenar('DataEmissao','number')">Data Emissão <?=compara($localOrdem,"DataEmissao",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
					...
					<?
						if($localCodigoNFOcultar == 2){
							echo "<td>
									<a href=\"javascript:filtro_ordenar('CodigoNF','text')\">Código NF ".compara($localOrdem,"CodigoNF",$ImgOrdernarASC,'')."</a>
								</td>";
						}
					?>
					<td />
