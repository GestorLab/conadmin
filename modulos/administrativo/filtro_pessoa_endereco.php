...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_pessoa_endereco.php' target='conteudo'>
			...
			<table>
				...
				<tr>
					...
					<td><img onmousemove="quadro_alt(event, this, 'Menu Avançado')" src='../../img/estrutura_sistema/seta_baixo.gif' style='cursor:pointer' onClick="consulta_rapida('bottom'); atualiza_campo();" alt='<?=dicionario(167)?>' /></td>
						...
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									...
									<td>
										<select name='filtro_estado' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="busca_filtro_cidade_estado(this.value)">
											<option value=''></option>
											<?
								...
								<tr>
									...
									<td>
										<select name='filtro_cidade' style='width:264px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown="listar(event)">
											<option value=''></option>
										</select>
									</td>
								</tr>
								<tr>
									...
									<td><input type='text' name='filtro_endereco' value='<?=$localEndereco?>' style='width:258px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" /></td>
								</tr>
							</table>
