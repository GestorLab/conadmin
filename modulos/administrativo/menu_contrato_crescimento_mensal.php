...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_crescimento_mensal.js'></script>
		<style type='text/css'>
			.impress { padding: 0 2px 2px 2px; cursor:pointer; border: 1px #A4A4A4 solid; height: 20px;}
		</style>
		<link rel = 'stylesheet' type = 'text/css' href = '../../css/impress.css' media = 'print' />
	</head>
	<body onLoad="ativaNome('<?=dicionario(383)?>')">
		<div id='carregando'><?=dicionario(17)?></div>
		<? include('filtro_contrato_crescimento_mensal.php'); ?>
		<br /><br />
