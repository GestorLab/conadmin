<?
	...
	$localContaReceber				= $_GET['ContaReceber'];
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/conta_receber_excluir.js'></script>
	</head>
	<body  onLoad="ativaNome('Contas a Receber/Excluir Registros')">
		<? include("filtro_conta_receber_excluir.php"); ?>
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				...
				<xsl:element name="tr">
					...
					<xsl:element name="td">
						...
						<xsl:element name="img">
							...
							<xsl:attribute name="onClick">excluir(<xsl:value-of select="IdContaReceber"/>)</xsl:attribute>
						</xsl:element>
					</xsl:element>
				</xsl:element>
				</xsl:for-each>
				<tr class='tableListarTitle'>
					...
					<td />
					<td class='valor' id='tableListarReceb'><xsl:value-of select='format-number(sum(db/reg/ValorRecebidoSoma),"0,00","euro")' /></td>
					<td colspan='5' />
				</tr>
			</table>
		</div>
