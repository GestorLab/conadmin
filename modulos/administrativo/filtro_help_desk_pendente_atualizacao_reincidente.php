<?
	...
	if($localOcultarlocalAber == ''){		$localOcultarlocalAber = getCodigoInterno(3,233);}
...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_help_desk_pendente_atualizacao_reincidente.php'>
					...
					<td colspan='7'>
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									<td><?=dicionario(1037)?></td>
									<td>
										<select name='filtro_ocultar_local_aber' style='width:81px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'  onChange="atualizaSessao(this.name,this.value)">
											<?
												...
												while($lin = @mysql_fetch_array($res)){
													...
													echo "<option value='$lin[IdParametroSistema]' ".compara($localOcultarlocalAber,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
