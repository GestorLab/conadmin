<?
	...
	$filtro_assinatura			= $_POST['filtro_assinatura'];
	...
	if($filtro_assinatura!=''){
		$filtro_url .= "&Assinatura=".$filtro_assinatura;
		$filtro_sql .= " and Contrato.AssinaturaContrato = '$filtro_assinatura'";
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_parametro_assinatura_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	$sql	=	"select
				    Contrato.IdContrato,
				    Contrato.IdServico,
				    substring(Servico.DescricaoServico,1,30) DescricaoServico,
				    Contrato.IdPessoa,				    
					Pessoa.TipoPessoa,
	...
	while($lin	=	mysql_fetch_array($res)){
		...
		$lin[AssinaturaContrato] = getCodigoInterno(9,$lin[AssinaturaContrato]);
		...
		echo 	"<AssinaturaContrato>$lin[AssinaturaContrato]</AssinaturaContrato>";
