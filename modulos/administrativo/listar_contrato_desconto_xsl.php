<?
	...
	$localIdTipoDesconto			= $_GET['IdTipoDesconto'];
	$localDescontoInicio			= url_string_xsl($_GET['DescontoInicio'],'url',false);
	$localDescontoTermino			= url_string_xsl($_GET['DescontoTermino'],'url',false);
	...
	if($acesso == '')				$acesso = 'filtro_contrato_desconto.php';
		...
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('IdTipoDesconto')"><?=dicionario(315)?>.<?=compara($localOrdem,"IdTipoDesconto",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
					...
					<td class='valor'>
						<a href="javascript:filtro_ordenar('ValorDescontoPercentual','number')"><?=dicionario(286)?>. (%)<?=compara($localOrdem,"ValorDescontoPercentual",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
				...
				<xsl:element name="tr">
					...
					<td class='valor'>
						...
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_contrato.php?acesso=<?=$acesso?>&amp;IdContrato=<xsl:value-of select="IdContrato"/></xsl:attribute>
							<xsl:value-of select="ValorDescontoPercentualTemp"/>
						</xsl:element>
					</td>						
					<td class='valor'>
						<xsl:attribute name="bgcolor"><xsl:value-of select="Color"/></xsl:attribute>
				...
				<tr class='tableListarTitle'>
					...
					<td class='valor' id='tableListarDescontoPercentual'><xsl:value-of select='format-number(sum(db/reg/ValorDescontoPercentualSoma),"0,00","euro")' /></td>
