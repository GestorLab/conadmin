...
<html>	
	...
	<body onLoad="ativaNome('Boleto Cancelado')">
		<div id='sem_permissao'>
			<p id='p1' style='margin-left:15px'>Título Cancelado</p>
			<p id='p2' style='margin-left:15px'>Este Título está Cancelado. </br>Caso queira imprimir mesmo assim, clique no botão abaixo para continuar.</p>
			</br>
