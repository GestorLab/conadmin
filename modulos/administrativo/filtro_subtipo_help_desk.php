...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_subtipo_help_desk.php'>
			...
			<table>
				<tr>
					...
					<td>Descrição SubTipo</td>
					<td>Status</td>
					<td>Qtd.</td>
					<td />
				</tr>
				<tr>
					<td><input type='text' value='<?=$localDescricaoTipo?>' name='filtro_descricao_tipo' style='width:282px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" /></td>
					<td><input type='text' value='<?=$localDescricaoSubTipo?>' name='filtro_descricao_subtipo' style='width:282px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" /></td>
					<td>
