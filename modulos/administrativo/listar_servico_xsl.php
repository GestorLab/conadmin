<?
	...
	$local_filtroTerceiro		= $_GET['IdTerceiro'];
	$local_filtro_email_cobraca	= $_GET['EmailCobranca'];
	$local_categoriaTributaria	= $_GET['IdCategoriaTributaria'];
	$local_tipo_nota_fiscal		= $_GET['IdNotaFiscalTipo'];
	$local_executarRotinas		= $_GET['ExecutarRotinas'];
	$local_idTipoPessoa			= $_GET['Filtro_IdTipoPessoa'];
	$local_periodicidade		= $_GET['IdPeriodicidade'];
	$local_servicosDesativados	= $_GET['ServicoDesativados'];
	$local_idPaisEstadoCidade	= $_GET['Filtro_IdPaisEstadoCidade'];
			...
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				...
				<xsl:element name="tr">
					...
					<td>
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_servico.php?IdServico=<xsl:value-of select="IdServico"/></xsl:attribute>
							<xsl:value-of select="TipoServico"/>
						</xsl:element>
					</td>
					<td>
						<xsl:element name="a">
