<?
	...
	$local_UsuarioAtendimento		= $_GET['UsuarioAtendimento'];	
	$local_UsuarioCadastro			= $_GET['UsuarioCadastro'];	
	$local_UsuarioConclusao			= $_GET['UsuarioConclusao'];	
	$local_UsuarioFaturamento		= $_GET['UsuarioFaturamento'];	
	$local_TipoPessoa				= $_GET['TipoPessoa'];	
	$localDataAbertura				= $_GET['DataAbertura'];
	$localDataConclusao				= $_GET['DataConclusao'];
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('Nome')"><?=dicionario(488)?><?=compara($localOrdem,"Nome",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
