<?
	...
	$filtro_desconto				= $_POST['filtro_desconto'];
	...
	$filtro_data_inicio	=	$_SESSION["filtro_data_inicio"];
	$filtro_data_fim	=	$_SESSION["filtro_data_fim"];
	...
	if($filtro_desconto!=""){
		$filtro_url  .= "&Desconto=".$filtro_desconto;
		
		switch($filtro_desconto){
			case 1:
				$filtro_sql  .= " and ContaReceberDados.ValorDesconto > 0";
				break;
			case 2:
				$filtro_sql  .= " and LancamentoFinanceiro.ValorDescontoAConceber > 0";
				break;
			case 3:
				$filtro_sql  .= " and ContaReceberDados.ValorDesconto = 0 and LancamentoFinanceiro.ValorDescontoAConceber = 0";
				break;				
		}
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_conta_receber_valores_recebidos_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	$sql	=	"select
				...
				where
					...
					ContaReceberDados.ValorFinal != ContaReceberRecebimento.ValorRecebido and
