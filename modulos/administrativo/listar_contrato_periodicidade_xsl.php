<?
	...
	$localIdPeriodicidade			= $_GET['IdPeriodicidade'];
	$localDataInicioCobranca		= $_GET['DataInicioCobranca'];	
	$localMesFechado				= $_GET['MesFechado'];
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_periodicidade.js'></script>
	</head>
	<body  onLoad="ativaNome('<?=dicionario(349)?>')">
		<? include("filtro_contrato_periodicidade.php"); ?>
		...
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtroOrdenar('DescricaoPeriodicidade','text')"><?=dicionario(224)?> <?=compara($localOrdem,"DescricaoPeriodicidade",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('QtdParcela','number')"><?=dicionario(353)?> <?=compara($localOrdem,"QtdParcela",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('TipoContrato')"><?=dicionario(82)?> <?=compara($localOrdem,"TipoContrato",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('MesFechado','text')"><?=dicionario(354)?>. <?=compara($localOrdem,"MesFechado",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('DiaCobranca','number')"><?=dicionario(293)?>. <?=compara($localOrdem,"DiaCobranca",$ImgOrdernarASC,'')?></a>
					</td>			
					<td style='width: 70px'>
						<a href="javascript:filtroOrdenar('DataPrimeiraCobranca','number')"><?=dicionario(355)?>.<?=compara($localOrdem,"DataPrimeiraCobranca",$ImgOrdernarASC,'')?></a>
					</td>
					<td style='width: 70px'>
