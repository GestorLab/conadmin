<?
	...
	$localValorParametroServico		= url_string_xsl($_GET['ValorParametroServico'],'');
	...
	if($acesso == '')	$acesso = 'filtro_contrato_sem_cobranca_aberto.php';
...
<html>	
	...
	<body  onLoad="ativaNome('<?=dicionario(297)?>')">
		<? include("filtro_contrato_sem_cobranca_aberto.php"); ?>
