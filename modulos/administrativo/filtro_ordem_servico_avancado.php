...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_ordem_servico_avancado.php'>
			...
			<table>
				...
				<tr>
					<td><input type='text' name="filtro_nome" value="<?=$localNome?>" style='width:150px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" onkeyup="busca_pessoa_aproximada(this,event);" /></td>
					<td>
						<select name='filtro_grupo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:120px' onKeyDown="listar(event)" onChange="busca_login_usuario(this.value,document.filtro.filtro_usuario)">
					...
					<td>
						<select name='filtro_usuario' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:100px' onKeyDown="listar(event)">
							<option value=''><?=dicionario(153)?></option>
						</select>
					</td>
					<td>
						<select name='filtro_campo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:105px'  onKeyDown="listar(event)">
							<option value=''><?=dicionario(153)?></option>
							...
							<option value='DataCancelamento' <?=compara($localCampo,"DataCancelamento","selected='selected'","")?>><?=dicionario(667)?></option>
							...
							<option value='MesCancelamento' <?=compara($localCampo,"MesCancelamento","selected='selected'","")?>><?=dicionario(981)?></option>
