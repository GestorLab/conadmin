...
<html>	
	...
	<body  onLoad="ativaNome('Grupo Permissão/Permissão')">
			...
			<form name='formulario' method='post'>
				...
				<div>
					<table>
						<tr>
							<td class='find'>&nbsp;</td>
							<td class='descCampo'><B style='margin-right:12px'>Grupo Perm.</B>Nome Grupo Permissão</td>
						...
						<tr>
							...
							<td class='separador'>&nbsp;</td>
							<td class='campo'>
								<select style='width:408px' name='IdLoja' onChange="busca_modulo()" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" tabindex='2'>
									<?
										$sql = "select IdLoja, DescricaoLoja from Loja where IdLoja in (".lojas_permissao_login($local_Login_Sistema).") order by DescricaoLoja";
					...
					<table>
						...
						<tr>
							...
							<td class='find'>
								...
								<img src='../../img/estrutura_sistema/ico_seta_right.gif' alt='Remover' onClick="quadro_permissao('rem')" />
							</td>
							<td class='find'>&nbsp;</td>
							<td class='campo'>
								<select style='width:375px' name='IdOperacaoOpcao' size=6 tabindex='6' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" multiple>
							</td>
						</tr>
					</table>
				</div>	
