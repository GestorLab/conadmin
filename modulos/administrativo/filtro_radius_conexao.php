...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_radius_conexao.php' onSubmit='return validar()'>
			<input type='hidden' name='corRegRand'					value='<?=getParametroSistema(15,1)?>' />
			<input type='hidden' name='filtro' 						value='s' />
			<input type='hidden' name='filtro_ordem'				value='<?=$localOrdem?>' />
			<input type='hidden' name='filtro_ordem_direcao'		value='<?=$localOrdemDirecao?>' />
			<input type='hidden' name='filtro_tipoDado'				value='<?=$localTipoDado?>' />
			<input type='hidden' name='filtro_dia_referencia_temp'	value='<?=$localDiaReferencia?>' />
			<table>
				<tr>
					<td>Servidor</td>
					<td>Login</td>
				...
				<tr>
					<td>
						<select name='filtro_servidor' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:210px'  onKeyDown="listar_radius(event);">
							<option value=''></option>
							<?
					...
					<td><input type='text' name='filtro_login' value='<?=$localLogin?>' style='width:100px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown="listar_radius(event);"/></td>
					...
					<td><input type='text' name='filtro_mac' value='<?=$localMAC?>' style='width:100px' maxlength='17' onkeypress="mascara(this,event,'mac')" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown="listar_radius(event);"/></td>
					<td>
						<select name='filtro_dia_referencia' value='' style='width:70px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out');"  onKeyDown="listar_radius(event);">
							<option value='' selected='selected'>Todos</option>
						</select>
					</td>
					<td><input type='text' name='filtro_mes_referencia' value='<?=$localMesReferencia?>' style='width:60px' maxlength='7' onkeypress="mascara(this,event,'mes')" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onChange="return atualizar_filtro_mes(this);" onKeyDown="listar_radius(event);" /></td>
