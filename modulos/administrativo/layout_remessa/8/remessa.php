...
#Débito Automático - Versão 05 - REMESSA - Vrs. 2.0 150 posições
...
### // Registro Header de Lote
	...
	// Campo  9 (Versão do Lay-out)								[2]  80-81		N
	$Campo[9] = "05";
...
### // Registro Detalhe
	...
	while($lin = mysql_fetch_array($res)){
		...
		if($lin[NumeroAgencia] != '' && $lin[NumeroConta] != '' && $lin[DigitoConta] != ''){
			...
			// Campo  2 (Identificação do Cliente na Empresa)			[25]  2-26		N  
			...
			// Campo  4 (Identificação do Cliente no Banco)				[14]  31-44		X 
			...
			// Campo  8 (Número do documento)							[15]  70-85		N gerado com posições do uso da empresa
			...
			// Campo  11 (Tipo de identificação)						[1]  130-130	N 
			$Campo[11] = $lin[TipoPessoa];
			$Campo[11] = preenche_tam($Campo[11], 1, '');

			// Campo  12 (Identificação)								[15] 131-145	N 
