<?
	...
	$localIdPessoa				= $_GET['IdFornecedor'];
	$Limit						= $_GET['Limit'];
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('Nome','text')">Nome Fornecedor <?=compara($localOrdem,"Nome",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='bt_lista' />
				</tr>
				...
				<xsl:element name="tr">
					...
					<td class='sequencial'  style='width:25px'>
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_fornecedor.php?IdPessoa=<xsl:value-of select="IdPessoa"/></xsl:attribute>
...
<script>
	...
	addParmUrl("marFornecedor","IdPessoa",'<?=$localIdPessoa?>');
