<?
	...
	// Campo 22 (Numero do terminal telefфnico ou nъmero da conta de consumo) [12] 210-221 X
	$Campo[22] =  preenche_tam("", 12, 'X');

	// Campo 23 (Brancos - Reserva) [5] 222-226 X
	$Campo[23] =  preenche_tam("", 5, 'X');

	// Campo 24 (Cуdigo de autenticaзгo digital do registro) [32] 227-258 X
