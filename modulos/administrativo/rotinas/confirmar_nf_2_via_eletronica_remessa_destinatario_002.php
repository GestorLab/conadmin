<?
	...
	// Campo 11 (Telefone) [12] 184-195 N
	$Campo[11] = preenche_tam(formata_telefone($NF[Telefone]), 12, 'N');

	// Campo 12 (Codigo de Identificaзгo do Consumidor) [12] 196-207
	$Campo[12] = preenche_tam($NF[IdContaReceber], 12, 'X');

	// Campo 13 (Numero do Terminal Telefonico) [12] 208-219 X
	$Campo[13] =  preenche_tam("", 12, 'X');

	// Campo 14 (UF Terminal Telefonico) [2] 220-221 X		
	$Campo[14] =  preenche_tam("", 2, 'X');

	// Campo 15 (Brancos) [5] 222-226 X
	$Campo[15] =  preenche_tam("", 5, 'X');

	// Campo 16 (Cуdigo de Autenticaзгo Digital do registro) [32] 227-258 X
