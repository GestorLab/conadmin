<?
	...
	$localOcultarlocalAber	= $_GET['OcultarLocalAbertura'];
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/help_desk_pendente_atualização_reincidente.js'></script>
	</head>
	<body onLoad="ativaNome('Help Desk/Pendente Atualização - Reincidente')">
		<? include('filtro_help_desk_pendente_atualizacao_reincidente.php'); ?>
