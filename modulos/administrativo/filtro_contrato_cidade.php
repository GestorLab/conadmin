...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_contrato_cidade.php'>
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name='filtro_status' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:190px' onKeyDown='listar(event)'>
							<option value=''><?=dicionario(153)?></option>
							<?
