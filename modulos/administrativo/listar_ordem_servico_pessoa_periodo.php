<?
	...
	$filtro_data_abertura			= $_POST['filtro_data_abertura'];
	$filtro_data_conclusao			= $_POST['filtro_data_conclusao'];
	...
	$filtro_usuario_faturamento		= $_POST['filtro_usuario_faturamento'];
	$filtro_usuario_cadastro		= $_POST['filtro_usuario_cadastro'];
	$filtro_usuario_conclusao		= $_POST['filtro_usuario_conclusao'];
	...
	if($filtro_usuario_atendimento!=""){
		...
		$filtro_sql .= " and OrdemServico.LoginAtendimento like '%$filtro_usuario_atendimento%'";
	}
	if($filtro_usuario_cadastro!=""){
		$filtro_url .= "&UsuarioCadastro=".$filtro_usuario_cadastro;
		$filtro_sql .= " and OrdemServico.LoginCriacao = '$filtro_usuario_cadastro'";
	}
	if($filtro_usuario_faturamento!=""){
		$filtro_url .= "&UsuarioFaturamento=".$filtro_usuario_faturamento;
		$filtro_sql .= " and OrdemServico.LoginFaturamento = '$filtro_usuario_faturamento'";
	}
	if($filtro_usuario_conclusao!=""){
		$filtro_url .= "&UsuarioConclusao=".$filtro_usuario_conclusao;
		$filtro_sql .= " and OrdemServico.LoginConclusao = '$filtro_usuario_conclusao'";
	}
	...
	if($filtro_data_abertura!=''){
		$filtro_url .= "&DataAbertura=$filtro_data_abertura";
		$filtro_data_abertura 	= dataConv($filtro_data_abertura,"d/m/Y","Y-m-d");
		$filtro_sql .=	" and substr(OrdemServico.DataCriacao,1,10) >= '$filtro_data_abertura'";
	}
	if($filtro_data_conclusao!=''){
		$filtro_url .= "&DataConclusao=$filtro_data_conclusao";
		$filtro_data_conclusao 	= dataConv($filtro_data_conclusao,"d/m/Y","Y-m-d");
		$filtro_sql .=	" and substr(OrdemServico.DataCriacao,1,10) <= '$filtro_data_conclusao'";
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_ordem_servico_pessoa_periodo_xsl.php$filtro_url\"?>";
	echo "<db>";
