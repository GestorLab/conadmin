...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/pessoa_data_cadastro.js'></script>
	</head>
	<body onLoad="javascript:ativaNome('Pessoa/Data Cadastro');"> 
		<? include("filtro_pessoa_data_cadastro.php"); ?>
