<?
	...
	$lin[Data] = "
		<table cellpadding='0' cellspacing='0'>
			<tr>
				<td><b>Data Início Cont.:</b> ".dataConv($lin[DataInicio],'Y-m-d','d/m/Y')."</td>";
	...
	if($lin[DataTermino]!=""){
		$lin[Data] .= "<td><b>Data Término Cont.:</b> ".dataConv($lin[DataTermino],'Y-m-d','d/m/Y')."</td>";
	}
	
	if($lin[DataUltimaCobranca]!=""){
		$lin[Data] .= "<td><b>Data Última Cob.:</b> ".dataConv($lin[DataUltimaCobranca],'Y-m-d','d/m/Y')."</td>";
	}
			...
			<body>
				<div id='conteiner'>
					...
					<table id='quadro' cellspacing='0' cellpadding='0'>
						...
						<tr>
							<td colspan='3' style='padding:0 11px 0 11px;'><b>Serviço:</b> [$lin[IdServico]] $lin[DescricaoServico]</td>
						</tr>
						<tr>
							<td style='padding:0 0 0 11px;'><b>Local de Cobrança:</b> $lin[DescricaoLocalCobranca]</td>
	...
	while($lin2 = mysql_fetch_array($res2)){
		...
		$Impress .= "	<div style='margin:11px 0 11px 0;'>
							<table style='width:100%; border:1px solid #000;' cellpadding='0' cellspacing='0'>
								...
								<tr><td colspan='2' class='sub_titulo'>Parâmetros do Contrato</td></tr>
								<tr>
									<td colspan='2' style='padding:0 11px 0 11px;'>
										$ParametroContrato
									</td>
