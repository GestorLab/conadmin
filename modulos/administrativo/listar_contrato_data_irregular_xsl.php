...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_data_irregular.js'></script>
	</head>
	<body  onLoad="ativaNome('Contrato com Data Irregular')">
		<? include("filtro_contrato_data_irregular.php"); ?>
