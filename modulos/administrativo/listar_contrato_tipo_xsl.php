...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_tipo.js'></script>
	</head>
	<body  onLoad="ativaNome('<?=dicionario(372)?>')">
		<? include("filtro_contrato_tipo.php"); ?>
