		...
		<form name='filtro' method='post' action='listar_help_desk_conteudo_historico.php'>
			...
			<table>
				...
				<tr>
					...
					<td><input type='text' value='<?=$localAssunto?>' name='filtro_assunto' style='width:180px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown='listar(event)'/></td>
					<td><input type='text' value='<?=$localHistorico?>' name='filtro_historico' style='width:180px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown='listar(event)'/></td>
					<td>
						...
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									...
									<td>
										<select name='filtro_local_abertura' style='width:181px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'>
											<option value=''>Todos</option>
											<?
