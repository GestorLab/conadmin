<?
	...
	$filtro_grupo_responsavel		= $_POST['filtro_grupo_responsavel'];
	$filtro_usuario_responsavel		= $_POST['filtro_usuario_responsavel'];
	...
	if($filtro_usuario_responsavel!=""){
		$filtro_url	.= "&GrupoResponsavel=".$filtro_grupo_responsavel."&UsuarioResponsavel=".$filtro_usuario_responsavel;
		$filtro_sql	.= " and HelpDesk.LoginResponsavel = '$filtro_usuario_responsavel'";
	}
	if($filtro_grupo_responsavel!=""){
		$filtro_url	.= "&GrupoResponsavel=".$filtro_grupo_responsavel;
		$filtro_sql	.= " and HelpDesk.IdGrupoUsuario = $filtro_grupo_responsavel";
	}
		...
		switch($filtro_campo){
			case 'DataPrevisao':
				if($filtro_valor!=""){
					...
					$filtro_sql    .= " and HelpDesk.PrevisaoEtapa like '$filtro_valor%'";
				}else{
					$filtro_sql    .= " and HelpDesk.PrevisaoEtapa is NULL";
				}
				break;
			case 'MesPrevisao':
				if($filtro_valor!=""){
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_help_desk_previsao_xsl.php$filtro_url\"?>";
	echo "<db>";
