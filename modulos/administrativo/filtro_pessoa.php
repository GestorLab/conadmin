<?
	...
	$localPessoaForcarAtualizacao	=	$_SESSION["filtro_pessoa_forcar_atualizacao"];
	$localPessoaSexo				=	$_SESSION["filtro_pessoa_sex"];
	$localPessoaEstadoCivil			=   $_SESSION["filtro_pessoa_estado_civil"];
	$localPessoaTaxaCobranca		=   $_SESSION["filtro_pessoa_taxa_de_cobranca"];
	$localPessoaAgruparContratos    =   $_SESSION["filtro_pessoa_agrupar_contratos"];
	$localPessoaEnderecoPrincipal   =   $_SESSION["filtro_pessoa_endereco_principal"];
	$localPessoaMonitorarFinanc		=   $_SESSION["filtro_pessoa_monitorar_financ"];
	
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_pessoa.php' target='conteudo'>
				...
				<tr>
					...
					<td>
						<select name='filtro_campo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:130px'  onKeyDown="listar(event)">
							...
							<option value='InscricaoEstadual' <?=compara($localCampo,"InscricaoEstadual","selected='selected'","")?>><?=dicionario(95)?></option>
							<option value='InscricaoMunicipal' <?=compara($localCampo,"InscricaoMunicipal","selected='selected'","")?>><?=dicionario(96)?></option>
							<option value='DataNascimento' <?=compara($localCampo,"DataNascimento","selected='selected'","")?>><?=dicionario(97)?></option>
					...
					<td colspan='8'>
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									<td style='width:271px'><?=dicionario(121)?></td>
									<td>
										<select name='filtro_pessoa_forcar_atualizacao' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												...
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaForcarAtualizacao,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(86)?></td>
									<td>
										<select name='filtro_pessoa_sex' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 8 order by IdParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaSexo,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(88)?></td>
									<td>
										<select name='filtro_pessoa_estado_civil' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 9 order by IdParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaEstadoCivil,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(108)?></td>
									<td>
										<select name='filtro_pessoa_taxa_de_cobranca' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 105 order by ValorParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaTaxaCobranca,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(109)?></td>
									<td>
										<select name='filtro_pessoa_agrupar_contratos' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 105 order by ValorParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaAgruparContratos,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(110)?></td>
									<td>
										<select name='filtro_pessoa_endereco_principal' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 105 order by ValorParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaEnderecoPrincipal,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									<td style='width:271px'><?=dicionario(111)?></td>
									<td>
										<select name='filtro_pessoa_monitorar_financ' style='width:264px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema = 105 order by ValorParametroSistema;";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
													echo "<option value='$lin[IdParametroSistema]' ".compara($localPessoaMonitorarFinanc,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>
									</td>
