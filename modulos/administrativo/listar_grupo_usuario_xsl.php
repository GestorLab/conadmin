		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('DescricaoGrupoUsuario')">Nome Grupo Permissão <?=compara($localOrdem,"DescricaoGrupoUsuario",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('OrdemServico')">Grupo para Ordem de Serviço <?=compara($localOrdem,"OrdemServico",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='bt_lista' />
				</tr>
