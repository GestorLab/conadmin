	...
	function busca_servico_parametro_nota_fiscal_layout(IdNotaFiscalTipo,Erro){	
		if(IdNotaFiscalTipo == ''){
			IdNotaFiscalTipo = 0;
		}	
		...
		if (window.XMLHttpRequest) { // Mozilla, Safari,...
	   	...
	   	url = "../administrativo/xml/servico_parametro_nota_fiscal_layout.php?IdNotaFiscalTipo="+IdNotaFiscalTipo;
			...
			if(xmlhttp.readyState == 4){ 
				if(xmlhttp.status == 200){
					...
					if(xmlhttp.responseText == 'false'){																								
						...
						busca_servico_parametro_nota_fiscal(document.formulario.IdServico.value,IdNotaFiscalLayout,Erro,false);
