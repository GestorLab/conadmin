				...
				if(xmlhttp.responseText == 'false'){
					...
					switch(Local){
						case 'Carteira':
							...
							document.formulario.Restringir.value			= 	"";
					...
					addParmUrl("marCarteiraComissionamento","IdCarteira",IdCarteiraTemp);
					addParmUrl("marCarteiraComissionamentoNovo","IdCarteira",IdCarteiraTemp);
					addParmUrl("marCarteira","IdCarteira",IdCarteiraTemp);
					addParmUrl("marAgenteAutorizado","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marAgenteAutorizadoComissionamento","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marAgenteAutorizadoComissionamentoNovo","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marCarteira","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marCarteiraNovo","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marCarteiraComissionamento","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
					addParmUrl("marCarteiraComissionamentoNovo","IdAgenteAutorizado",IdAgenteAutorizadoTemp);
