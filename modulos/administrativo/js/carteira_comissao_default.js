function busca_carteira_comissao(IdAgenteAutorizado,IdCarteira,IdServico,Parcela,Erro,Local){
	...
	if (window.XMLHttpRequest) { // Mozilla, Safari,...
   	...
   	url = "xml/carteira_comissao.php?IdAgenteAutorizado="+IdAgenteAutorizado+"&IdCarteira="+IdCarteira+"&IdServico="+IdServico+"&Parcela="+Parcela;
		...
		if(xmlhttp.readyState == 4){ 
			if(xmlhttp.status == 200){
				...
				if(xmlhttp.responseText == 'false'){
					...
					nameNode = xmlhttp.responseXML.getElementsByTagName("NomeCarteira")[0]; 
					nameTextNode = nameNode.childNodes[0];
					...
					document.formulario.NomeCarteira.value			=	NomeCarteira;
