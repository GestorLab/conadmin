	...
	function inicia(){
		habilitar_campo_pessoa();
		document.formulario.AnoReferencia.focus();
	}
	function habilitar_campo_pessoa(valor){
		if(valor == '' || valor == undefined){
			document.formulario.IdPessoaFiltro.readOnly	= true;
		} else{
			document.formulario.IdPessoaFiltro.readOnly	= false;
		}
	}
