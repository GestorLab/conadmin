		...
		if ( Acao == "alterar"){
			...
			call_ajax(url, function (xmlhttp) {
				if(xmlhttp.responseText != 'false'){
					...
					if (res2 < res1){
						var alterar_data = confirm( "ATENÇÃO!\n\n A Data Início de Cobrança do contrato é menor que a Data Inicio da Vigência atual.\nDeseja continuar?","SIM","NAO");
					    if(alterar_data){
			...
			if(xmlhttp.responseText != "false"){
				...
				if(Ativa == 0){
					...
					var ResumoUltimaConexao = new Array(
						...
						"<strong>Tipo Conexão: </strong>"+TipoConexao,
						"<strong>IP: </strong>"+IP,
						"<strong>MAC: </strong>"+MAC,
						"<strong>Data Início: </strong>"+dateFormat(DataInicio)
					);
		...
		call_ajax(url,function (xmlhttp){
			if(xmlhttp.responseText != "false"){
				...
				var ResumoUltimaConexao = new Array(
					...
					"<strong>MAC: </strong>"+MAC,
					"<strong>Data Início: </strong>"+dateFormat(DataInicio),
					"<strong>Data Término: </strong>"+dateFormat(DataTermino),
