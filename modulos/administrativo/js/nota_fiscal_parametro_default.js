function busca_nota_fiscal_parametro(IdNotaFiscalTipo,IdNotaFiscalLayout,Erro,Local){
	if(IdNotaFiscalTipo == '' || IdNotaFiscalTipo == undefined){
		IdNotaFiscalTipo = 0;
	}
    ...
    url = "xml/nota_fiscal_parametro.php?IdNotaFiscalTipo="+IdNotaFiscalTipo+"&IdNotaFiscalLayout="+IdNotaFiscalLayout;
