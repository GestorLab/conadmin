<?
	...
	$filtro_historico			= $_POST['filtro_historico'];
	...
	if($filtro_historico!=""){
		$filtro_url	.= "&Historico=".$filtro_historico;
		$filtro_sql	.= " and (HelpDeskHistorico.Obs like '%".$filtro_historico."%')";
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_help_desk_conteudo_historico_xsl.php$filtro_url\"?>";
	echo "<db>";
