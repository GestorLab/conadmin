<?
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_data_irregular_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	$sql	=	"select
				...
				where
					...
					(Contrato.DataInicio = '0000-00-00' or 
				     Contrato.DataTermino = '0000-00-00' or 
				     Contrato.DataBaseCalculo = '0000-00-00' or 				    
					 Contrato.DataPrimeiraCobranca = '0000-00-00' or 
				     DataUltimaCobranca = '0000-00-00' or 
				     Contrato.DataUltimoBloqueio = '0000-00-00' or 						 
					 Contrato.DataInicio like '0000-%' or 
				     Contrato.DataTermino like '0000-%' or 
				     Contrato.DataBaseCalculo like '0000-%' or 				    
					 Contrato.DataPrimeiraCobranca like '0000-%' or 
				     DataUltimaCobranca like '0000-%' or 
				     Contrato.DataUltimoBloqueio like '0000-%' or 
					 Contrato.DiaCobranca = 0 or 
				     Contrato.DiaCobranca = '' or 
				     Contrato.DiaCobranca is NULL)					
					$filtro_sql
				group by
