<?
	...
	$localHistorico			= url_string_xsl($_GET['Historico'],'');
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/help_desk_conteudo_historico.js'></script>
	</head>
	<body onLoad="ativaNome('Help Desk/Conteúdo Histórico')">
		<? include('filtro_help_desk_conteudo_historico.php'); ?>
