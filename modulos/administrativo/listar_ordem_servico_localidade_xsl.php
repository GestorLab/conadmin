...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/ordem_servico_localidade.js'></script>
	</head>
	<body  onLoad="ativaNome('<?=dicionario(500)?>')">
		<? include('filtro_ordem_servico_localidade.php'); ?>
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				...
				<tr class='tableListarTitle'>
					<td colspan='3' id='tableListarTotal'><?=dicionario(140)?>: <xsl:value-of select="count(db/reg)" /></td>
					<td />
					<td />				
					<td />
					<td />
