<?
	...
	$localValorParametroServico		= $_GET['ValorParametroServico'];
	$localContratoAtivo				= $_GET['ContratoAtivo'];
		...
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td style='width: 76px'>
						<a href="javascript:filtroOrdenar('DataInicio','number')"><?=dicionario(308)?> <?=compara($localOrdem,"DataInicio",$ImgOrdernarASC,'')?></a>
					</td>
					<td style='width: 76px'>
