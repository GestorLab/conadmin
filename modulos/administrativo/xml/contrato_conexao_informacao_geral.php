	...
	function get_ConexaoGeral(){
		...
		if($lin[ValorCodigoInterno] != ''){
			...
			$sql = "SELECT
						...
						IF(framedprotocol = 'PPP', 'PPPoE','hotspot') TipoConexao,
						IF(acctstoptime IS NULL OR acctstoptime = '0000-00-00 00:00:00', 1, 0) Ativa
					FROM
						radacct
					WHERE
						username = '$UserName'
