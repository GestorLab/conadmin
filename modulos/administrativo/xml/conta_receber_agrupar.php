<?
	...
	function get_Conta_Receber(){
		...
		if($IdStatusValido != ''){					
			if($Local == "Carne"){
				$where .= " and ContaReceberDados.IdStatus != 0";	
		...
		if($Local == "Carne" || $Local == "ContratoStatus" || $Local == "ContratoServico"){
			...
			$orderBy = "order by LancamentoFinanceiroDados.IdPessoa,Tipo,Codigo,IdLancamentoFinanceiro";
		}
		...
		$sql	=	"select
						...
						(
						IF(
							LancamentoFinanceiroDados.Tipo = 'CO',
							LancamentoFinanceiroDados.IdContrato,
							IF(
								LancamentoFinanceiroDados.Tipo = 'EV',
								LancamentoFinanceiroDados.IdContaEventual,
								IF(
									LancamentoFinanceiroDados.Tipo = 'OS',
									LancamentoFinanceiroDados.IdOrdemServico,
									IF(
										LancamentoFinanceiroDados.Tipo = 'CR',
										LancamentoFinanceiroDados.IdContaReceber,
										IF(
											LancamentoFinanceiroDados.Tipo = 'EF',
						...
						(
							ContaReceberDados.ValorLancamento + ContaReceberDados.ValorDespesas
						) Valor,
