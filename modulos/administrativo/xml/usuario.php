...
#	include ('../../../rotinas/verifica.php');
	...
	function get_usuario(){
		...
		if($IdStatus !=''){	 				 
			$where  .= " and Usuario.IdStatus != '$IdStatus'";	 
		}
		...
		while($lin	=	@mysql_fetch_array($res)){
			...
			$dados	.=	"\n<ForcaAlterarSenha><![CDATA[$lin[ForcarAlteracaoSenha]]]></ForcaAlterarSenha>";
			$dados	.=	"\n<IdAcessoSimultaneo><![CDATA[$lin[AcessoSimultaneo]]]></IdAcessoSimultaneo>";
			$dados	.=	"\n<IdStatus><![CDATA[$lin[IdStatus]]]></IdStatus>";
			$dados	.=	"\n<DataCriacao><![CDATA[$lin[DataCriacao]]]></DataCriacao>";
			$dados	.=	"\n<LoginCriacao><![CDATA[$lin[LoginCriacao]]]></LoginCriacao>";
			$dados	.=	"\n<DataAlteracao><![CDATA[$lin[DataAlteracao]]]></DataAlteracao>";
			$dados	.=	"\n<LoginAlteracao><![CDATA[$lin[LoginAlteracao]]]></LoginAlteracao>";
			$dados	.=	"\n<QtdLoginInvalido><![CDATA[$lin[QtdLoginInvalido]]]></QtdLoginInvalido>";
		}
		if(mysql_num_rows($res) >=1){
			$dados	.=	"\n</reg>";
			return $dados;
