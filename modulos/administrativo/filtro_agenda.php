...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_agenda.php'>
			...
			<table>
				<tr>
					<td><?=dicionario(813)?></td>
					<td><?=dicionario(814)?></td>
				...
				<tr>
					<td><input type='text' name='filtro_data' value='<?=$localData?>' style='width:100px' maxlength='10' onkeypress="mascara(this,event,'date')" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" /></td>
					<td><input type='text' name='filtro_hora' value='<?=$localHora?>' style='width:100px' maxlength='5' onkeypress="mascara(this,event,'hora')" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown="listar(event);" /></td>	
