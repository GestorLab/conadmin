<?
	...
	$filtro_campo_ordenacao		= $_POST['filtro_campo_ordenacao'];
	...
	if($filtro_data_inicio!=""){
		...
		if($filtro_campo_ordenacao != 'DataCadastroPessoa'){
			$filtro_sql .= " and Contrato.$filtro_campo_ordenacao >= '$filtro_data_inicio'";
		}else{
			$filtro_sql .= " and Pessoa.DataCriacao >= '$filtro_data_inicio'";
		}		
	}
	...
	if($filtro_data_termino!=""){
		...
		if($filtro_campo_ordenacao != 'DataCadastroPessoa'){
			$filtro_sql .= " and Contrato.$filtro_campo_ordenacao <= '$filtro_data_termino'";
		}else{
			$filtro_sql .= " and Pessoa.DataCriacao <= '$filtro_data_termino'";
		}
	}
	
	if($filtro_campo_ordenacao!=""){
		$filtro_url .= "&CampoOrdenacao=".$filtro_campo_ordenacao;
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_novo_xsl.php$filtro_url\"?>";
	echo "<db>";
