...
<html>	
	...
	<body onLoad="ativaNome('Help Desk/Login e Data de Criação')">
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				...
				<xsl:element name="tr">
					...
					<td>
						...
						<xsl:element name="a">							
							...
							<xsl:attribute name="alt"><xsl:value-of select="DescricaoMarcador"/></xsl:attribute>
							<xsl:attribute name="title"><xsl:value-of select="DescricaoMarcador"/></xsl:attribute>
				...
				<tr class='tableListarTitle'>
					<td colspan='10' id='tableListarTotal'>Total: <xsl:value-of select="count(db/reg)" /></td>	
				</tr>
			</table>
			<table>
				<tr>
