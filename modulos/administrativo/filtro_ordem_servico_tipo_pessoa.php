...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_ordem_servico_tipo_pessoa.php'>
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name='filtro_campo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:115px'  onKeyDown="listar(event)">
							<option value=''><?=dicionario(153)?></option>
					...
					<td>
						<select name='filtro_idstatus' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:90px' onKeyDown="listar(event)">
							<option value=''><?=dicionario(153)?></option>
							<?
