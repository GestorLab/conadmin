<?
	...
	$localDataHoraInicio		= url_string_xsl($_GET['DataHoraInicio'],'');
	$localDataHoraFim			= url_string_xsl($_GET['DataHoraFim'],'');
	$localDataHoraEspecifica	= url_string_xsl($_GET['DataHoraEspecifica'],'');
...
<html>	
	...
	<body  onLoad="ativaNome('Radius/Usuários/Período')">
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('UserName')">Login/MAC <?=compara($localOrdem,"UserName",$ImgOrdernarASC,'')?></a>
					</td>
					<?
						if($localOcultaIP == 2){
							echo"
							<td>
								<a href=\"javascript:filtro_ordenar('IP','number')\">IP ".compara($localOrdem,"IP",$ImgOrdernarASC,'')."</a>
							</td>
							";
						}
						if($localOcultaMAC == 2){
							echo"
							<td>
								<a href=\"javascript:filtro_ordenar('MAC','number')\">MAC ".compara($localOrdem,"MAC",$ImgOrdernarASC,'')."</a>
							</td>
							";
						}
						if($localOcultaNAS == 2){
					...
					<td>
						<a href="javascript:filtro_ordenar('DataFim','number')">Data Término <?=compara($localOrdem,"DataFim",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
				...
				<xsl:element name="tr">
					...
					<td>
						<xsl:value-of select="DataFimTemp"/>
					</td>
					<td>
