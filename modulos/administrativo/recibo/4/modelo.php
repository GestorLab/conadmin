		...
		<div id='container'>
			...
			<table cellspacing='0' class='via1' style='margin-top:3px;'>
				...
				<tr>
						...
						<table cellspacing='0' id='tabela_demonstrativo' border="0">
							...
							<?
								...
								while($linContaReceber = mysql_fetch_array($resContaReceber)){
									...
									$TotalMultaJuros 			+= 	number_format(($linContaReceber[ValorMulta]+$linContaReceber[ValorJuros]),2,'.',',');
									$TotalValorDesconto			+= 	number_format($linContaReceber[ValorDesconto],2,'.',',');
								}
					...
					<td style='text-align:right;'><?=$TotalValorLancamento?></td>
				</tr>
				<tr style='font-size:9px;'>
