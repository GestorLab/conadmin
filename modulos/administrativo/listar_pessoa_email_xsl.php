...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/pessoa_email.js'></script>
	</head>
	<body onLoad="javascript:ativaNome('<?=dicionario(191)?>');"> 
		<? include("filtro_pessoa_email.php"); ?>
			...
			<table class='tableListar' id='tableListar' cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td style='width:150px'>
						<a href="javascript:filtro_ordenar('Email');"><?=dicionario(104)?><?=compara($localOrdem,"Email",$ImgOrdernarASC,'');?></a>
					</td>
					<td>
