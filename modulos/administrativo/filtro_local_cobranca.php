...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_local_cobranca.php'>
			...
			<table class='filtro'>
				<tr>
					<td><?=dicionario(817)?></td>
					<td><?=dicionario(82)?></td>
					<td><?=dicionario(818)?></td>
				...
				<tr>
					...
					<td>
						<select name='filtro_tipo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:170px' onKeyDown='listar(event)'>
							...
							<?
								...
								while($lin = mysql_fetch_array($res)){
									...
									echo "<option value='$lin[IdParametroSistema]' ".compara($localIdTipoLocalCobranca,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
								}
							?>
						</select>
					</td>
					<td><input type='text' value='<?=$localAbreviacao?>' name='filtro_abreviacao' size='10' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown='listar(event)'/></td>
					<td>
						<select name='filtro_status' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:100px' onKeyDown='listar(event)'>
							...
							<?
								...
								//	echo"<option value='$lin[IdParametroSistema]'  ".compara($localIdStatus,$lin[IdParametroSistema],"selected", "").">$lin[ValorParametroSistema]</option>";
								}
							?>
						</select>
					</td>
