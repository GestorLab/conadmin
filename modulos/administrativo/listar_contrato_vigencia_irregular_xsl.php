<?
	...
	if($acesso == '')	$acesso = 'filtro_contrato_vigencia_irregular.php';
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_vigencia_irregular.js'></script>
	</head>
	<body  onLoad="ativaNome('Contrato com Vigências Irregulares')">
		<? include("filtro_contrato_vigencia_irregular.php"); ?>
		...
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('AbreviacaoNomeLocalCobranca','text')"><?=dicionario(290)?>.<?=compara($localOrdem,"AbreviacaoNomeLocalCobranca",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
				...
				<xsl:element name="tr">
					...
					<td class='sequencial'>					
						...
						<xsl:element name="a">
							<xsl:attribute name="href">listar_vigencia.php?IdContrato=<xsl:value-of select="IdContrato"/></xsl:attribute>
					...
					<td class='valor'>						
						<xsl:attribute name="bgcolor"><xsl:value-of select="Color"/></xsl:attribute>
						<xsl:element name="a">
							<xsl:attribute name="href">listar_vigencia.php?acesso=<?=$acesso?>&amp;IdContrato=<xsl:value-of select="IdContrato"/></xsl:attribute>
