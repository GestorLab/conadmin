...
<html>
	...
	<body>
		...
		<div id='filtro_busca'>
			<form name='formulario2' method='post'>
				<table>
					...
					<tr>
						<td class='campo'>
							<input type='text' name='Nome' autocomplete="off" value='<?=$local_Nome?>' style='width:365px' maxlength='100' onkeyup="busca_carteira_lista()" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')">
						</td>
						<td class='campo'>
							<input type='text' name='CPF_CNPJ' value='<?=$local_CPF_CNPJ?>' autocomplete="off" style='width:125px' maxlength='18' onFocus="Foco(this,'in',true)"  onBlur="Foco(this,'out')" onkeyup="busca_carteira_lista()">
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td>
							<select name='IdPais'  style='width:113px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onChange="busca_carteira_lista(); verifica_estado(this.value)">
						...
						<td class='campo'>
							<input type='text' name='NomeCidade' value='<?=$local_NomeCidade?>' style='width:220px' maxlength='100' onkeyup="busca_carteira_lista()" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')">
						</td>
					</tr>
				</table>
			</form>
		...
		<form name='formulario' method='post' action='busca_carteira.php' onSubmit='return validar()'>
...
<script>
	...
	function validar(){
		if(valorCampo !=''){
			window.opener.busca_carteira(valorCampo);
		}
		return false;
	}
	...
	function aciona(campo,valor){
		...
		if(valorCampo == valor){
			window.opener.busca_carteira(valor,true,window.opener.document.formulario.Local.value);
		}
		valorCampo = valor;
		document.formulario.IdCarteira.value = valorCampo;
