...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_produto.php'>
			...
			<table class='filtro'>
				...
				<tr>
					...
					<td  style='font-size:9px; font-weight:normal'><a style='color:#FFF'  href='listar_produto_opcoes.php'>Outros<BR />Relatórios</a></td>
				</tr>
			</table>
		</form>
	</div>
