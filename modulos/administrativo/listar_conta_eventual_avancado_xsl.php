		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('NumeroDocumento','number')"><?=dicionario(423)?>. <?=compara($localOrdem,"NumeroDocumento",$ImgOrdernarASC,'')?></a>
					</td>
					<?
				...
				<tr class='tableListarTitle'>
					<td colspan='2'><?=dicionario(128)?>: <xsl:value-of select="count(db/reg)" /></td>
					<td />
					<?
						if($localNotaFiscal == 2){
							echo"<td />";
