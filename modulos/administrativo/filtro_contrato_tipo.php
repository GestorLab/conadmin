...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_contrato_tipo.php'>
			...
			<input type='hidden' name='filtro_contrato_cancelado'	value='<?=$localContratoCancelado?>' />
			...
			<table>
				...
				<tr>
					<td><input type='text' value="<?=$localPessoa?>" name='filtro_pessoa' style='width:180px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" onKeyDown="listar(event)" onkeyup="busca_pessoa_aproximada(this,event);" /></td>
					...
					<td>
						<select name='filtro_tipo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:120px' onKeyDown='listar(event)'>
					...
					<td>
						<select name='filtro_vencimento' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:100px' onKeyDown='listar(event)'>
							<option value=''><?=dicionario(153)?></option>
							<?
								...
								$res = @mysql_query($sql,$con);
								while($lin = @mysql_fetch_array($res)){
									echo"<option value='$lin[ValorCodigoInterno]' ".compara($localDiaCobranca,$lin[ValorCodigoInterno],"selected='selected'","").">".visualizarNumber($lin[ValorCodigoInterno])."</option>";
								}
							?>
						</select>
					</td>
					<td>
						<select name='filtro_contrato_assinado' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:100px' onKeyDown='listar(event)'>
							<option value=''><?=dicionario(153)?></option>
							<?
								...
								$res = @mysql_query($sql,$con);
								while($lin = @mysql_fetch_array($res)){
									$lin[ValorCodigoInterno] = substituir_string($lin[ValorCodigoInterno]);
									echo"<option value='$lin[IdCodigoInterno]' ".compara($localAssinaturaContrato,$lin[IdCodigoInterno],"selected='selected'","").">$lin[ValorCodigoInterno]</option>";
								}
							?>
						</select>
					</td>
					...
					<td><img onmousemove="quadro_alt(event, this, 'Menu Avançado');" src='../../img/estrutura_sistema/seta_baixo.gif' style='cursor:pointer' onClick="consulta_rapida('bottom');atualizar_campo();" alt='<?=dicionario(167)?>' /></td>
						...
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									...
									<td>
										<select name='filtro_parametro' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:220px' onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>	
											<?
								...
								<tr>
									...
									<td>
										<input type='text' value='<?=$localValorParametroServico?>' name='filtro_valor_parametro' style='width:215px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" onKeyDown="listar(event)" />
									</td>
								</tr>
								<tr>
									<td><?=dicionario(40)?></td>
									<td><select name='filtro_local_cobranca' style='width:220px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
								...
								<tr>
									<td><?=dicionario(174)?></td>
									<td>
										<select name='filtro_status' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:220px' onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
