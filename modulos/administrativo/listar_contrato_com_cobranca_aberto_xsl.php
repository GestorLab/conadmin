<?
	...
	if($acesso == '')	$acesso = 'filtro_contrato_com_cobranca_aberto.php';
...
<html>	
	...
	<body  onLoad="ativaNome('Contrato com Cobranca em Aberto')">
		<? include("filtro_contrato_com_cobranca_aberto.php"); ?>
