<?
	...
	$localIdPosicaoCobranca			= $_GET['IdPosicaoCobranca'];
	$localAlteracaoAte				= $_GET['DataVencimento'];
	$localAlteracaoDe				= $_GET['DataLancamento'];
...
<html>	
	...
	<body  onLoad="ativaNome('<?=dicionario(1017)?>')">
		<div id='carregando'><?=dicionario(17)?></div>
		<? include('filtro_conta_receber_posicao_cobranca.php'); ?>
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('IdPosicaoCobranca','text')"><?=dicionario(1019)?> <?=compara($localOrdem,"IdPosicaoCobranca",$ImgOrdernarASC,'')?></a>
					</td>					
					<td />
					<td class='bt_lista' />
				</tr>
				...
				<xsl:element name="tr">
					...
					<xsl:element name="td">
						...
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_conta_receber.php?IdContaReceber=<xsl:value-of select="IdContaReceber"/></xsl:attribute>
							<xsl:value-of select="IdPosicaoCobranca"/>
						</xsl:element>
					</xsl:element>
					<xsl:element name="td">
						<xsl:attribute name="bgcolor"><xsl:value-of select="Color"/></xsl:attribute>
