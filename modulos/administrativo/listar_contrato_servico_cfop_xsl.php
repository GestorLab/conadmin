<?
	...
	$localIdServico					= $_GET['IdServico'];
	$localCFOP						= $_GET['CFOP'];
	$localNomeCFOP					= url_string_xsl($_GET['NomeCFOP'],'url',false);
	$Limit							= $_GET['Limit'];
	
	if($acesso == '')	$acesso = 'filtro_contrato_servico_cfop.php';
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_servico_cfop.js'></script>
	</head>
	<body  onLoad="ativaNome('Contrato/Serviço/CFOP')">
		<div id='carregando'>carregando</div>
		<? include("filtro_contrato_servico_cfop.php"); ?>
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					<td class='id_listar'>
						<a href="javascript:filtroOrdenar('IdContrato','number')">Id<?=compara($localOrdem,"IdContrato",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
					...
					<td>
						<a href="javascript:filtroOrdenar('DescricaoServico')">Nome Serviço <?=compara($localOrdem,"DescricaoServico",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('DiaCobranca','number')">Venc. <?=compara($localOrdem,"DiaCobranca",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('TipoContrato')">Tipo <?=compara($localOrdem,"TipoContrato",$ImgOrdernarASC,'')?></a>
					</td>
					<td style='width: 70px'>
						<a href="javascript:filtroOrdenar('DataInicio','number')">Início<?=compara($localOrdem,"DataInicio",$ImgOrdernarASC,'')?></a>
					</td>
					<td style='width: 70px'>
						<a href="javascript:filtroOrdenar('DataTermino','number')">Término<?=compara($localOrdem,"DataTermino",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtroOrdenar('AbreviacaoNomeLocalCobranca','text')">Local Cob.<?=compara($localOrdem,"AbreviacaoNomeLocalCobranca",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
						<a href="javascript:filtroOrdenar('Valor','number')">Valor (<?=getParametroSistema(5,1)?>)<?=compara($localOrdem,"Valor",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
						<a href="javascript:filtroOrdenar('ValorDesconto','number')">Desc. (<?=getParametroSistema(5,1)?>)<?=compara($localOrdem,"ValorDesconto",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
					...
					<td>
						<a href="javascript:filtroOrdenar('Status','text','DataTemporaria','number')">Status <?=compara($localOrdem,"Status",$ImgOrdernarASC,'')?></a>
					</td>					
					<td class='bt_lista' />
				</tr>
