...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/contrato_pessoa.js'></script>
		<script type = 'text/javascript' src = 'js/contrato.js'></script>
	</head>
	<body  onLoad="ativaNome('<?=dicionario(356)?>')">
		<? include("filtro_contrato_pessoa.php"); ?>
		...
		<div id='conteudo'>
			<table class='tableListar' id='tableListar'  cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('DataCadastro','number')"><?=dicionario(359)?><?=compara($localOrdem,"DataCadastro",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
