		...
		<table cellspacing=0 cellpadding=0 border=0>
			<tbody>
				<tr>	
					...
					<td class=ct valign=top width=56 height=14>Agência/Código do Cedente</td>
					<td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
		...
		<table cellspacing=0 cellpadding=0 border=0>
			<tbody>
				<tr>
					...
					<td class=ct  width=7 height=5></td><td class=ct  width=88 >Autenticação mecânica</td>
				</tr>
			</tbody>
		</table>
			...
			<table cellspacing=0 cellpadding=0 width=666 border=0>
				<tbody>
					<tr>
						...
						<td valign=top width=600 rowspan=5><font class=ct>Instruções (Texto de responsabilidade do cedente)</font>
