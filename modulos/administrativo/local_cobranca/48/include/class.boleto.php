...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/48/";
		}
		...
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(37,2.5,$dadosboleto["ponto_venda"]."    ".substr($dadosboleto["codigo_cliente"],0,6)."-".substr($dadosboleto["codigo_cliente"],6,7),0,0,'C',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(10,2.5,$dadosboleto["especie"],0,0,'C',0);
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(15,2.5,$dadosboleto["quantidade"],0,0,'C',0);
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(31.3,2.5,substr($dadosboleto["nosso_numero"],0,12)."-".substr($dadosboleto["nosso_numero"],12,13),0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->SetFont('Arial','',6.5);
		$this->Cell(0.4,3,'','',0,'',1);
		$this->Cell(18.4,3,'Sacado:','T',0,'L',0);
		$this->SetFont('Arial','B',6.5);
		$this->Cell(171.6,3.5,$dadosboleto["sacado"],'T',0,'',0);
				
		$this->Ln();
		$this->SetFont('Arial','B',6.5);
		$this->Cell(0.4,3,'','',0,'',1);
		$this->Cell(18.4,3,'',0,0,'',0);
		$this->Cell(171.6,3,$dadosboleto["endereco1"],'',1,'L',0);
		$this->Cell(0.4,3,'','',0,'',1);
		$this->Cell(18.4,3,'',0,0,'',0);
		$this->Cell(171.6,3,$dadosboleto["endereco_2"]." CEP: ".$dadosboleto["cep"],'',1,'L',0);
		// LINHA DO SACADO/AVALISTA
		
		$this->SetFont('Arial','',6.5);
		$this->Cell(0.4,3,'','',0,'',1);
		$this->Cell(167.6,3,'Sacado/Avalista:',0,0,'L',0);
		...
		$i=11;
		while($i < 200){
			$this->Image($PatchImagens."imagens/6.jpg",$i,($posTemp + 42),1,0.1,jpg);
			$i += 3;
		}
		$this->Ln();
		$this->Cell(40,0.2,'','');
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logobanespa.jpg",11,($posTemp + 43.8),38.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(46.9,2.5,$dadosboleto["ponto_venda"]."    ".substr($dadosboleto["codigo_cliente"],0,6)."-".substr($dadosboleto["codigo_cliente"],6,7),0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(47,2.5,substr($dadosboleto["nosso_numero"],0,12)."-".substr($dadosboleto["nosso_numero"],12,13),0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->SetFillColor(255,255,255);
		$this->Cell(58.9,3.5,'Carteira','T',0,'L',1);
		$this->SetFillColor(0,0,0);
		$this->Cell(0.5,3.5,'','T',0,'',0);
		$this->Cell(0.5,3.5,'','T',0,'',1);
		...
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(58.9,2.5,$dadosboleto["carteira"],0,0,'L',1);
		$this->SetFillColor(0,0,0);
		$this->Cell(0.5,2.5,'',0,0,'',0);
		$this->Cell(0.5,2.5,'',0,0,'',1);
		...
		$this->SetFont('Arial','B',7.5);
		$this->Cell(131.1,3.5,$Instrucoes[0],'',0,'L',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'','',0,'',0);	
		$this->Cell(131.2,2,$Instrucoes[7],'',0,'L',0);
		$this->SetFont('Arial','',6.5);
		$this->Cell(8,3,'','',0,'L',0);
		$this->Cell(0.5,3,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(46.9,3,'(=) Valor cobrado','T',0,'L',1);
		$this->Cell(3,3,'','T',0,'',1);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(8,2,'',0,0,'L',0);
		$this->Cell(0.5,2,'',0,0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(46.9,2,'',0,0,'C',1);
		$this->Cell(3,2,'','',0,'',1);
		
		$this->Ln();
		$this->SetFont('Arial','',6.5);
		$this->Cell(0.4,3,'','LT',0,'',1);
		$this->Cell(18.4,3,'Sacado:','T',0,'L',0);
		$this->SetFont('Arial','B',6.5);
		$this->Cell(171.6,3,$dadosboleto["sacado"],'T',0,'',0);
				
		$this->Ln();
		$this->SetFont('Arial','B',6.5);
		$this->Cell(0.4,3,'','L',0,'',1);
		$this->Cell(18.4,3,'',0,0,'L',0);
		$this->Cell(171.6,3,$dadosboleto["endereco1"],'',1,'L',0);
		$this->Cell(0.4,3,'','L',0,'',1);
		$this->Cell(18.4,3,'',0,0,'',0);
		$this->Cell(171.6,3,$dadosboleto["endereco_2"]." CEP: ".$dadosboleto["cep"],'',0,'L',0);
		
		
		// LINHA DO SACADO/AVALISTA
		$this->Ln();
		$this->SetFont('Arial','',6.5);
		$this->Cell(0.4,3,'','LB',0,'',1);
		$this->Cell(189.6,3,'Sacado/Avalista:','B',0,'L',0);
