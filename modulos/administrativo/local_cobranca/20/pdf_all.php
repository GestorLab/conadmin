<?
	$IdLocalCobrancaLayout = 20;
	$EndFile 	= "modulos/administrativo/local_cobranca/20/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/20/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/20/include/funcoes_cef_sigcb.php");
