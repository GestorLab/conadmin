		...
		if($CobrancaParametro[Reaviso] != 2){
			...
			while($lin = @mysql_fetch_array($res)){
				...
				if($i == 1){
					...
					$this->Cell(25,$this->height_cell,'Vencimento',0,0,'R',1);
					$this->Cell(25,$this->height_cell,'Valor ('.getParametroSistema(5,1).')',0,0,'R',1);
					$this->Ln();
				...
				if($i <= 5){
					...
					$this->Cell(25,$this->height_cell,$lin[DataVencimento],0,0,'R',1);
