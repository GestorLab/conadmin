<?
	$IdLocalCobrancaLayout = 45;
	$EndFile 	= "modulos/administrativo/local_cobranca/45/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/45/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/45/include/funcoes_santander_banespa.php");
