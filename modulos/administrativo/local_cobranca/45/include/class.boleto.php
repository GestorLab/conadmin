...
*/
		...
		$this->RotatedText(32,$Y2-14,"Recibo do Sacado - Autenticação Mecânica no verso",90);
		...
		$this->RotatedText(23.5,$Y5-1,"N. NÚMERO",90);
		...
		$this->RotatedText(23.5,$Y2-2,"AG./CÓD. CED.",90);
