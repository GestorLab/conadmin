...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/42/";
		}

	    $this->Image($PatchImagens."imagens/logo_banco.jpg",11,($posTemp + 0.5),24,5,jpg);
		$this->Cell(40,6,'','T');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','T',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,'037-0','T',0,'C',0);
		$this->Cell(0.4,6,'','T',0,'',1);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logo_banco.jpg",11,($posTemp + 37.5),24.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,'037-0','',0,'C',0);
		$this->Cell(0.4,6,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3,'','',0,'',0);
		$this->Cell(60.6,3,"FICHA DE COMPENSAÇÃO",'',0,'R',0);
	}
