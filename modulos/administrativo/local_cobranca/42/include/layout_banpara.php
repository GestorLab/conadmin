...
<META NAME="keywords" CONTENT="Boleto, Dinamico, PHP, ASP, Itau, Bradesco, HSBC, Real, Banespa, Unibanco, Banco do Brasil, Sistemas, Sites, Cobrança Bancaria"> <META NAME="description" CONTENT="Sistema para criação de boletos on-lines código fonte em PHP ou ASP, como usar boletos bancarios.">
</HEAD>
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
<DIV align=center>
	<?
	...
	?>
	<table cellspacing=0 cellpadding=0 width=666 border=0<table cellspacing=0 cellpadding=0 width=661 border=0><tbody><tr><td class=cp width=137>
		  <div align=left><img src="imagens/logo_banco.jpg"></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=cpt  width=63 valign=bottom> 
		  <div align=center><font class=bc>037-0</font></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=ld align=right width=458 valign=bottom><span class=ld> 
	...
	<?=$dadosboleto["cedente"]?></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top width=126 height=12> 
	<?=$dadosboleto["agenciaVisual"]?>-<?=$dadosboleto["digito_agenciaVisual"]?> / <?=$dadosboleto["contaVisual"]?>-<?=$dadosboleto["digito_contaVisual"]?></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=34 height=12> 
	<?=$dadosboleto["especie"]?> </td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=53 height=12> 
	 </td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=120 height=12> 
	...
	<?=$dadosboleto["sacado"]?> </td></tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.gif width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=imagens/2.gif width=659 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=520 >Corte na linha pontilhada</td><td class=ct  width=10 height=12></td><td class=ct  width=129 >Autenticação 
	mecânica</td></tr><tr><td  width=7 ></td><td  width=520 ></td><td  width=10 ></td><td  width=129 ></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tbody><tr><td width=7></td><td  width=500 class=cp> 
	<?=$dadosboleto["instrucoes"]?></td><td width=159></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=ct width=666></td></tr><tbody><tr><td class=ct width=666>&nbsp;</td></tr><tr><td class=ct width=666><img height=1 src=imagens/6.gif width=665 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=664 border=0><tbody><tr><td class=cp width=136>
		  <div align=left><IMG SRC="imagens/logo_banco.jpg"></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=cpt  width=60 valign=bottom> 
		  <div align=center><font class=bc>037-0</font></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=ld align=right width=462 valign=bottom><span class=ld> 
	<?=$dadosboleto["linha_digitavel"]?>
	&nbsp;&nbsp;&nbsp;&nbsp; </span></td>
	...
	<?=$dadosboleto["cedente"]?> </td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12><?=$dadosboleto["agenciaVisual"]?>-<?=$dadosboleto["digito_agenciaVisual"]?> / <?=$dadosboleto["contaVisual"]?>-<?=$dadosboleto["digito_contaVisual"]?>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
	...
	Proc.</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>Nosso 
	...
	<?=$dadosboleto["especie"]?> </div></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=123> 
	 </td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=72> 
	 </td><td class=cp valign=top width=7 height=12> 
...
?></FONT>
	...
	<?=$dadosboleto["endereco2"]?></td></tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.gif width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=imagens/2.gif width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.gif width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.gif width=180 border=0></td></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50> 
	<? fbarcode($dadosboleto["codigo_barras"]); ?> </TD><TD style='text-align:right'>
		<?
