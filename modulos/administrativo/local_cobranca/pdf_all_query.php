<?
	...
	if($IdProcessoFinanceiro != ''){
		...
		$sqlQtdMax = "SELECT ValorCodigoInterno FROM CodigoInterno WHERE IdLoja = $IdLoja AND IdGrupoCodigoInterno = 17 AND IdCodigoInterno = 1";
		$resQtdMax = mysql_query($sqlQtdMax,$con);
		$linQtdMax = mysql_fetch_array($resQtdMax);
		$qtdMax = $linQtdMax[ValorCodigoInterno];
