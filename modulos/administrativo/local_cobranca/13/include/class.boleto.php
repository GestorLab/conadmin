...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/13/";
		}

	    $this->Image($PatchImagens."imagens/logo.jpg",11,($posTemp+0.5),38.5,5,jpg);
		$this->Cell(40,6,'','T');
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(31.3,2.5,$dadosboleto["nosso_numero_visual"],0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logo.jpg",11,($posTemp + 37.5),38.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(46.9,2.5,$dadosboleto["nosso_numero_visual"],0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
