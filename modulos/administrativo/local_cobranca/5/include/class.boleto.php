...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/5/";
		}
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(36,2.5,$dadosboleto["data_vencimento_visual"],0,0,'C',0);
		$this->Cell(0.5,2.5,'',0,0,'',1);
		...
		$this->SetFillColor(255,255,255);
		$this->Cell(46.8,2.5,$dadosboleto["data_vencimento_visual"],0,0,'R',1);
		$this->Cell(3,2.5,'','',0,'',1);
