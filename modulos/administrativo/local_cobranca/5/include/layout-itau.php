...
<DIV align=center>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
		<tr>
			<td><span class="campo"><IMG src="imagens/banco_itau.jpg" border=0></span></td>
			<td width=3 valign=bottom><img height=20 src=imagens/3.png width=2 border=0></td>
			<td class=cpt width=58 valign=bottom>
				<div align=center>
					<span class=ld><span class="campotitulo"><?=$codigobanco?></span></span>
				</div>
			</td>
			<td width=3 valign=bottom><img height=20 src=imagens/3.png width=2 border=0></td>
	...
	número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=298 height=12> 
	  <span class="campo"><?=substr($dadosboleto["cedente"],0,52); ?></span></td>
	<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=126 height=12> 
	  <span class="campo">
	  <?=$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"]?>
	  </span></td>
	...
	<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=134 height=12> 
	  <span class="campo">
	  <?php echo $dadosboleto["data_vencimento_visual"]?>
	  </span></td>
	...
	<div align=left>Corte na linha pontilhada</div></td></tr><tr><td class=ct width=666><img height=1 src=imagens/6.png width=665 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0 style='margin-top:10px'><tr><td class=cp width=150> 
	  <span class="campo"><IMG src="imagens/banco_itau.jpg" border=0></span></td>
	...
	<span class="campotitulo"><?=$codigobanco?></span></span></div></td><td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td><td class=ld align=right width=453 valign=bottom><span class=ld> 
	...
	<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12> 
	  <span class="campo"><?=$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"]?></span></td>
