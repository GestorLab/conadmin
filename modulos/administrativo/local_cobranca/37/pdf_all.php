<?
	$IdLocalCobrancaLayout = 37;
	$EndFile 	= "modulos/administrativo/local_cobranca/37/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/37/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/37/include/funcoes-itau.php");
