...
class Boleta extends FPDF
{
	...
	function DemonstrativoCarnePersonalizado($IdLoja, $IdCarne, $con){
		global $Path;
		include($Path."modulos/administrativo/local_cobranca/37/funcao_demonstrativo_carne_pdf.php");
	}
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/37/";
		}

	    $this->Image($PatchImagens."imagens/banco_itau.jpg",11,($posTemp + 0.5),19.5,5,jpg);
		$this->Cell(40,6,'','T');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','T',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,$codigobanco,'T',0,'C',0);
		$this->Cell(0.4,6,'','T',0,'C',1);
		...
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(37,2.5,$dadosboleto["agencia_codigo"].$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/banco_itau.jpg",11,($posTemp + 37.5),19.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(46.9,2.5,$dadosboleto["agencia_codigo"].$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3.5,'','',0,'',0);		
		$this->Cell(131.2,2.7,$Instrucoes[7],'',0,'L',0);
		$this->SetFont('Arial','',6.5);
		$this->Cell(8,3.5,'','',0,'L',0);
		$this->Cell(0.5,3.5,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		...
		if($dadosboleto["cob_outro"] == 'S'){
			...
			$this->Image($estrela,195,($posTemp + 109.5),3.35,3.35,jpg);
		}
	}
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,$dadosboleto["agencia_codigo"].$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$dadosboleto["agencia_codigo"].$dadosboleto["contadigito"],'LR',0,'R',0);
		$this->SetFillColor(0,0,0);
		
		$this->Cell(3,3,'',0,'',0);
		$this->SetFont('Arial','',8);
		$this->SetFillColor(0,0,0);
		$this->Cell(0.5,3,$dadosboleto["uso_banco"],0,0,'',1);
		$this->SetFillColor(255,255,255);
	...
	function Tracejado($Posicao){
		...
		$i=11;
		while($i < 200){
			$this->Image($PatchImagens."imagens/imgpxlazu.jpg",$i,$Posicao,1,0.1,jpg);
			$i += 3;
		}
	}
}
