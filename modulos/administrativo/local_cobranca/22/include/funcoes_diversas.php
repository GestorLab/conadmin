<?
	...
	//	$campo2 = substr($codigo,23,3) . substr($codigo,26,7);
		$campo2 = $campo2 . modulo_10($campo2);
		$campo2 = substr($campo2,0,5) . '.' . substr($campo2,5,6);
		
		// 3. Campo composto pelas posicoes 16 a 25 do campo livre
		// e livre e DV (modulo10) deste campo		
		$campo3 = substr($codigo,34,5) . substr($codigo,39,4) . substr($codigo,43,2); 
		//$campo3 = substr($codigo,33,5) . substr($codigo,38,4) . substr($codigo,42,2);
		$campo3 = $campo3 . modulo_10($campo3);
		$campo3 = substr($campo3,0,5) . '.' . substr($campo3,5,6);

		// 4. Campo - digito verificador do codigo de barras
//		echo  substr($codigo, 4, 1);
