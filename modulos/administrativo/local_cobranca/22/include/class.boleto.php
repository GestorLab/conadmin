...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
	    ...
	    $this->Image($PatchImagens."imagens/logoamazonia.jpg",11,($posTemp+0.5),27.5,5,jpg);
		$this->Cell(40,6,'','T');
		...
		$this->Cell(0.4,3.5,'','',0,'',1);
		$this->Cell(37,3.5,'Código do Cedende','T',0,'L',0);
		$this->Cell(0.4,3.5,'','',0,'',1);
		...
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(37,2.5,$dadosboleto["codigo_cedente"],0,0,'R',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logoamazonia.jpg",11,($posTemp + 37.5),27.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(139.4,2.5,'Pagável em qualquer Banco até o vencimento',0,0,'L',0);
		...
		$this->Cell(0.5,3.5,'','T',0,'',1);
		$this->Cell(46.9,3.5,'Código cedente','T',0,'L',0);
		$this->Cell(3,3.5,'','T',0,'',0);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(46.9,2.5,$dadosboleto["codigo_cedente"],0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
