...
<DIV align=center>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
		<tr>
			<td><span class="campo"><IMG src="imagens/logoamazonia.jpg" border=0></span></td>
			<td width=3 valign=bottom><img height=20 src=imagens/3.png width=2 border=0></td>
			<td class=cpt width=58 valign=bottom>
				<div align=center>
					<span class=ld><span class="campotitulo"><?php echo $dadosboleto["codigo_banco_com_dv"]?></span></span>
				</div>
			</td>
			<td width=3 valign=bottom><img height=20 src=imagens/3.png width=2 border=0></td>
	...
	</tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=659 height=13>Sacado</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=659 height=12> 
	  <span class="campo">
	  <?php echo $dadosboleto["sacado"]?>
	  </span></td>
	</tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=imagens/2.png width=659 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=564 >&nbsp;</td><td class=ct  width=7 height=12></td><td class=ct  width=240 >Autenticação 
	mecânica</td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=ct width=666></td></tr><tbody><tr><td class=ct width=666> 
	<div align=left>Corte na linha pontilhada</div></td></tr><tr><td class=ct width=666><img height=1 src=imagens/6.png width=665 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0 style='margin-top:10px'><tr><td class=cp width=150> 
	  <span class="campo"><IMG src="imagens/logoamazonia.jpg" border=0></span></td>
	<td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td>
	<td class=cpt width=58 valign=bottom><div align=center><span class=ld> 
	<span class="campotitulo"><?php echo $dadosboleto["codigo_banco_com_dv"]?></span></span></div></td><td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td><td class=ld align=right width=453 valign=bottom><span class=ld> 
	...
	Valor</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
	...
	<td valign=top width=468 rowspan=6><font class=ct>Instruções (Texto de responsabilidade do cedente)</font>
	<br><span class=cp> <FONT class=campo>
	<?
		InstrucoesBoletoHTML($IdContaReceber);
	?>
	</FONT> 
	<span class=cp>ARRECADAÇÃO BASA - CONVÊNIO: <?=$dadosboleto["convenio"]?>  AGÊNCIA: <?=$dadosboleto["agencia"]."-".$dadosboleto["agencia_digito"]?> </span>
	</span></td>
	...
	<TBODY>
	<TR>
	<TD vAlign=bottom align=left height=50 style='padding-top:1px'>
