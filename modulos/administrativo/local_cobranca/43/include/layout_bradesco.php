...
<DIV align=center>
	...
	<?=$dadosboleto["agencia_codigo"]?></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=34 height=12> 
	...
	<?=$dadosboleto["cedente"]?> </td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12> 
