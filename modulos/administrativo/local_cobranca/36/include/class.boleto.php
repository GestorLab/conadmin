...
class Boleta extends FPDF
{
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
		...
		$this->Image($PatchImagens."imagens/logo-bradesco.jpg",50,$posTemp+1.3,19.5,3.5,jpg);
		$this->Cell(27,6.5,'','');
		$this->SetFillColor(0,0,0);
		$this->SetFont('Arial','B',10);
		$this->Cell(0.4,6.5,'  237-2','',0,'L',1);		
		$this->Cell(15,6.5,$dadosboleto["codigo_banco_com_dv"],'',0,'C',0);
		$this->Cell(0.4,6.5,'','',0,'',1);
		$this->Cell(102.2,6.5,$dadosboleto["linha_digitavel"],'',0,'R',0);
		$this->Cell(3,6.5,'','',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,4,'','',0,'',1);
		$this->Cell(108.5,4,'Local de pagamento','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(31.5,4,'Vencimento','T',0,'L',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3,'',0,0,'',1);
		$this->Cell(108.5,3,$dadosboleto["local_pagamento"],0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(31.6,3,$dadosboleto["data_vencimento"],0,0,'R',1);
		$this->Cell(3,3,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,4,'','',0,'',1);
		$this->Cell(108.3,4,'Cedente','T',0,'L',0);
		$this->Cell(0.5,4,'',0,0,'',1);
		$this->Cell(31.6,4,'Agência / Código cedente','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3,'',0,0,'',1);
		$this->Cell(108.3,3,$dadosboleto["cedente"],0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,$dadosboleto["agencia_codigo"].$dadosboleto["conta_cedente_dv"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(19,4,'Data process.','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(31.6,4,'Nosso número','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(19,3,$dadosboleto["data_processamento"],0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,$dadosboleto["nosso_numero"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.4,4,'','T',0,'',1);
		$this->Cell(28.4,4,'Valor','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(31.6,4,'(=) Valor documento','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$dadosboleto["agencia_codigo"].$dadosboleto["conta_cedente_dv"],'LR',0,'R',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.4,3,'',0,0,'',1);
		$this->Cell(28.4,3,$dadosboleto["valor_unitario"],0,0,'R',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,$dadosboleto["valor_unitario"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(100.2,4,'Instruções (Texto de responsabilidade do cedente)','T',0,'L',0);
		$this->Cell(7.9,4,'','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(31.6,4,'(-) Desconto / Abatimento','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->Cell(100.2,3,$Instrucoes[0],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',8);
		$this->Cell(100.2,3,$Instrucoes[1],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(31.6,4,'(-) Outras deduções','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(100.2,1,$Instrucoes[2],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',8);
		$this->Cell(100.2,1.5,$Instrucoes[3],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(31.6,4,'(+) Mora / Multa','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(100.2,0,$Instrucoes[4],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',8);
		$this->Cell(100.2,1,$Instrucoes[5],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(31.6,4,'(+) Outros acréscimos','T',0,'L',0);
		$this->Cell(3,4,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(100.2,0,$Instrucoes[6],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.6,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,4,'','',0,'',0);
		$this->Cell(100.2,1,$Instrucoes[7],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.7,4,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(34.4,4,'(=) Valor cobrado','T',0,'L',1);
		$this->Cell(3,4,'','',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(100.2,0,$Instrucoes[8],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3.5,'','',0,'',1);
		$this->Cell(140.4,3.5,'Sacado','T',0,'L',0);
		$this->Cell(3,2.8,'','T',0,'',0);
		...
		$this->Cell(140.4,2.7,$dadosboleto["sacado"],0,0,'L',0);
		$this->Cell(3,2.7,'','',0,'',0);
		...
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3.8,'(=) Valor cobrado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(140.4,2.5,$dadosboleto["endereco1"],0,0,'L',0);
		$this->Cell(3,2.7,'','',0,'',0);
		...
		$this->SetFont('Arial','B',6.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.0,'','',0,'',1);
		$this->Cell(140.4,2.2,$dadosboleto["endereco2"],'B',0,'L',0);
		$this->Cell(3,2.2,'','B',0,'',0);
...
/**/
		...
		if($dadosboleto["cob_outro"] == 'S'){
			...
			$this->Image($estrela,195,275,3.35,3.35,jpg);
		}
		
		$this->SetY($posY+85.7);
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3.5,$sacado1,'LR',0,'L',0);
		$this->SetFillColor(0,0,0);

		$this->SetY($posY+89.4);
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3.5,$sacado2,'LRB',0,'L',0);
	}	
