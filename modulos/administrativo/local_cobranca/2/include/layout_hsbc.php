...
<DIV align=center>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
		<tr>
			<td><span class="campo"><IMG src="imagens/logohsbc.jpg" border=0></span></td>
	...
	<div align=left>Corte na linha pontilhada</div></td></tr><tr><td class=ct width=666><img height=1 src=imagens/6.png width=665 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0 style='margin-top:10px'><tr><td class=cp width=150> 
	  <span class="campo"><IMG src="imagens/logohsbc.jpg" border=0></span></td>
	...
	<?php echo $dadosboleto["endereco1"]?>
	  ...
	  </span></td></tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=imagens/2.png width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.png width=180 border=0></td></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 border=0 width=666><TBODY><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50><?php fbarcode($dadosboleto["codigo_barras"]); ?> 
	 </TD>
