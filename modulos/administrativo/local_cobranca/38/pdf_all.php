<?
	$EndFile 	= "modulos/administrativo/local_cobranca/38/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	$Path		=  substr($Vars[0],0,strlen($Vars[0])-strlen($EndFile)-1);

	$IdLocalCobrancaLayout = 38;
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/38/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/38/include/funcoes_cef.php");
