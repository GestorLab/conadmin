...
class Boleta extends FPDF
{
	...
	function TituloCarne($IdLoja, $IdContaReceber, $con){
		...
		$dadosboleto["codigo_banco_com_dv"]	= "341-7";  // Código da Carteira: pode ser SR (Sem Registro) ou CR (Com Registro) - (Confirmar com gerente qual usar)
		...
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/44/";
		}
