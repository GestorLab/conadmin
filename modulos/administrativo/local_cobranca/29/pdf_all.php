<?
	$EndFile 	= "modulos/administrativo/local_cobranca/29/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/29/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/29/include/funcoes-itau.php");
