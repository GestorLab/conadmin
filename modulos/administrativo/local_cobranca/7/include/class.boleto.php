...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/2/";
		}

	    $this->Image($PatchImagens."imagens/logobnb.jpg",11,($posTemp + 0.5),19.5,5,jpg);
		$this->Cell(40,6,'','T');
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logobnb.jpg",11,($posTemp + 37.5),19.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
	    ...
	    $this->Image($PatchImagens."imagens/logobnb.jpg",50,$posTemp,19.5,5,jpg);
		$this->Cell(65,6.5,'','');
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',7.5);
		$this->Cell(106.2,4,$Instrucoes[0],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'35','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,3,$Instrucoes[1],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',8);
		$this->Cell(106.2,4,$Instrucoes[2],'',0,'L',0);
		$this->SetFont('Arial','',7);
		$this->Cell(7.9,4,'19','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,3,$Instrucoes[3],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',8);
		$this->Cell(106.2,4,$Instrucoes[4],'',0,'L',0);
		$this->SetFont('Arial','',7);
		...
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$sacado1,'LR',0,'L',0);
		$this->SetFillColor(0,0,0);

		$this->SetY($posY+91.5);
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,5.2,$sacado2,'LRB',0,'L',0);
	}
