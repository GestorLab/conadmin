...
<DIV align=center>
	<?
		include("../33/cabecalho_html.php");
		include("../33/demonstrativo_html.php");
	?>
	<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150>
		<tr>
			<td><span class="campo"><IMG src="imagens/logocaixa.jpg" border=0></span></td>
			<td width=3 valign=bottom><img height=18 src=imagens/3.png width=2 border=0></td>
			<td class=ld align=center width=58 valign=bottom><span class=ld><span class="campotitulo"><?php echo $dadosboleto["codigo_banco_com_dv"]?></span></span></td>
			<td width=3 valign=bottom><img height=18 src=imagens/3.png width=2 border=0></td>
	...
	<tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=113 height=1><img height=1 src=imagens/2.png width=113 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=112 height=1><img height=1 src=imagens/2.png width=112 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=113 height=1><img height=1 src=imagens/2.png width=113 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=113 height=1><img height=1 src=imagens/2.png width=113 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.png width=180 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=659 height=13>Sacado</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=659 height=12> 
	  ...
	  <?php echo $dadosboleto["sacado"]?>
		...
		<tbody>
			<tr>
				<td class=ct  width=478 height=12>&nbsp;</td>
				<td class=ct  width=188 >Autenticação mecânica</td>
			</tr>
			<tr>
				<td class=ct width=666 colspan=2>Corte na linha pontilhada<br>
				<img height=1 src=imagens/6.png width=665 border=0></td>
			</tr>
			<tr>
				<td class=ct  width=478 height=12>&nbsp;</td>
				<td class=ct  width=188 >&nbsp;</td>
			</tr>
		</tbody>
		</table><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150>
		<tr>
			<td><span class="campo"><IMG src="imagens/logocaixa.jpg" border=0></span></td>
			<td width=3 valign=bottom><img height=18 src=imagens/3.png width=2 border=0></td>
			<td class=ld align=center width=58 valign=bottom><span class=ld><span class="campotitulo"><?php echo $dadosboleto["codigo_banco_com_dv"]?></span></span></td>
