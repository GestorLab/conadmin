<?
	$EndFile 	= "modulos/administrativo/local_cobranca/8/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/8/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/8/include/funcoes_bradesco.php");
