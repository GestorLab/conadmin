...
<DIV align=center>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0<table cellspacing=0 cellpadding=0 width=661 border=0><tbody><tr><td class=cp width=137>
		  <div align=left><img src="imagens/logo-bradesco.jpg"></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=cpt  width=63 valign=bottom> 
		  <div align=center><font class=bc>237-2</font></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=ld align=right width=458 valign=bottom><span class=ld> 
	...
	<?=$dadosboleto["instrucoes"]?></td><td width=159></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=ct width=666></td></tr><tbody><tr><td class=ct width=666>&nbsp;</td></tr><tr><td class=ct width=666><img height=1 src=imagens/6.gif width=665 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=664 border=0><tbody><tr><td class=cp width=136>
		  <div align=left><IMG SRC="imagens/logo-bradesco.jpg"></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=cpt  width=60 valign=bottom> 
		  <div align=center><font class=bc>237-2</font></div></td><td width=4 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=ld align=right width=462 valign=bottom><span class=ld> 
	<?=$dadosboleto["linha_digitavel"]?>
	&nbsp;&nbsp;&nbsp;&nbsp; </span></td>
