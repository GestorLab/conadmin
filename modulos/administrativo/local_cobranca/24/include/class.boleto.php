...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/24/";
		}

	    $this->Image($PatchImagens."imagens/logosicredi.jpg",11,($posTemp + 0.5),19.5,5,jpg);
		$this->Cell(40,6,'','T');
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logosicredi.jpg",11,($posTemp + 37.5),19.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
	    ...
	    $this->Image($PatchImagens."imagens/logosicredi.jpg",50,$posTemp,19.5,5,jpg);
		$this->Cell(65,6.5,'','');
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.4,6.5,'','',0,'',1);
		$this->Cell(103.2,6.5,$dadosboleto["linha_digitavel"],'',0,'R',0);
		$this->Cell(3,6.5,'','',0,'',0);
		...
		$this->Cell(0.5,3.5,'','T',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(28.5,3.5,'Vencimento','T',0,'L',1);
		$this->Cell(2.9,3.5,'','T',0,'',1);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(114.5,2,$dadosboleto["local_pagamento"],0,0,'L',0);
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(31.5,2,$dadosboleto["data_vencimento"],0,0,'R',1);
		$this->Cell(3,2,'','',0,'',1);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$cedente2,'LR',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(114.3,2.5,'Cedente','T',0,'L',0);
		$this->Cell(0.5,4,'',0,0,'',1);
		$this->Cell(28.5,2.5,'Agência / Código cedente','T',0,'L',0);
		$this->Cell(3,2.5,'','T',0,'',0);
		...
		$this->Cell(31.5,3,$dadosboleto["agencia_codigo"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,'Vencimento','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(25,2.5,'Data do documento','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(36.5,2.5,'Nº documento','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(17,2.5,'Espécie doc.','T',0,'L',0);
		$this->Cell(0.4,4,'','T',0,'',1);
		$this->Cell(9,2.5,'Aceite','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(25,2.5,'Data process.','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(28.5,2.5,'Nosso número','T',0,'L',0);
		$this->Cell(3,2.5,'','T',0,'',0);
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.5,2.5,$dadosboleto["nosso_numero"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,'Agência / Código cedente','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.5,4,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(25,2.5,'Uso do banco','T',0,'L',1);
		$this->SetFillColor(0,0,0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(20.5,2.5,'Carteira','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(15.4,2.5,'Espécie','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(17,2.5,'Quantidade','T',0,'L',0);
		$this->Cell(0.4,4,'','T',0,'',1);
		$this->Cell(34.4,2.5,'Valor','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(28.5,2.5,'(=) Valor documento','T',0,'L',0);
		$this->Cell(3,3,'','T',0,'',0);
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(31.5,3,$dadosboleto["valor_unitario"],0,0,'R',0);
		$this->Cell(3,3.2,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,'Nosso Número','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(106.2,2.5,'Instruções (Texto de responsabilidade do cedente)','T',0,'L',0);
		$this->Cell(7.9,4,'','T',0,'L',0);
		$this->Cell(0.5,4,'','T',0,'',1);
		$this->Cell(28.5,2.5,'(-) Desconto / Abatimento','T',0,'L',0);
		$this->Cell(3,2.5,'','T',0,'',0);
		...
		$this->Cell(106.2,4,$Instrucoes[0],0,0,'L',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.8,'(=) Valor documento','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,3,'','',0,'',0);
		$this->SetFont('Arial','B',5.5);
		$this->Cell(106.2,2.5,$Instrucoes[1],'',0,'L',0);
		$this->SetFont('Arial','',5.5);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(28.5,2.5,'(-) Outras deduções','T',0,'L',0);
		$this->Cell(3,3,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,3,$Instrucoes[2],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.8,'(-) Desconto / Abatimento','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(28.5,2.5,'(+) Mora / Multa','T',0,'L',0);
		$this->Cell(3,3,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,1.5,$Instrucoes[4],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.8,'(-) Outras deduções','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',5.5);
		$this->Cell(106.2,0,$Instrucoes[5],'',0,'L',0);
		$this->SetFont('Arial','',5.5);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		$this->Cell(28.5,2.5,'(+) Outros acréscimos','T',0,'L',0);
		$this->Cell(3,3,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,1,$Instrucoes[6],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.8,'(+) Mora / Multa','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',5.5);
		$this->Cell(106.2,0,$Instrucoes[7],'',0,'L',0);
		$this->SetFont('Arial','B',5.5);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.7,4,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(31.3,2.5,'(=) Valor cobrado','T',0,'L',1);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,'(+) Outros acréscimos','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3.5,'','',0,'',1);
		$this->Cell(143.4,2.5,'Sacado','T',0,'L',0);
		$this->Cell(3,2,'','T',0,'',0);
		...
		$this->Cell(148.4,3.5,$dadosboleto["sacado"],0,0,'L',0);
		$this->Cell(3,3.5,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,'(=) Valor cobrado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3,'','',0,'',1);
		$this->Cell(143.4,3,$dadosboleto["endereco2"],'B',0,'L',0);
		$this->Cell(3,3,'','B',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,'Sacado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,7,$sacado1,'LR',0,'L',0);
		$this->SetFillColor(0,0,0);

		$this->SetY($posY+78.5);
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.2,$sacado2,'LRB',0,'L',0);
	}
