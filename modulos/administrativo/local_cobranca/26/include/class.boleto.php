...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/26/";
		}
		...
		$this->Cell(128.9,3.5,'Cedente','T',0,'L',0);
		$this->Cell(0.4,3.5,'','',0,'',1);
		...
		$this->Cell(128.9,2.5,$dadosboleto["cedente"],0,0,'L',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3.5,'','',0,'',1);
		$this->Cell(186.8,3.5,'Cedente','T',0,'L',0);
		$this->Cell(3,3.5,'','T',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(186.8,2.5,$dadosboleto["cedente"],0,0,'L',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->Cell(0.6,3.5,'','',0,'',0);
		$this->SetFont('Arial','B',7.5);
		$this->Cell(131.2,3.9,$Instrucoes[1],'',0,'L',0);
		$this->SetFont('Arial','',6.5);
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
		...
		$this->Cell(0.5,3.5,'','T',0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(28.5,3.5,'CPF/CEI/CNPJ','T',0,'L',1);
		$this->Cell(2.9,3.5,'','T',0,'',1);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->SetFillColor(255,255,255);
		$this->Cell(31.5,2,$dadosboleto["cpf_cnpj"],0,0,'R',1);
		$this->Cell(3,2,'','',0,'',1);
		...
		$this->Cell(28.5,2.5,'Vencimento','T',0,'L',0);
		...
		$this->Cell(31.5,3,$dadosboleto["data_vencimento"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$dadosboleto["numero_documento"],'LR',0,'R',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',6);
		$this->Cell(106.2,1,$Instrucoes[3],'',0,'L',0);
		$this->SetFont('Arial','',5.5);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.5,4,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,-1,$Instrucoes[4],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,-2,$Instrucoes[6],0,0,'L',0);
		$this->Cell(7.9,3,'',0,0,'L',0);
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,'',0,0,'C',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,4,'(+) Outros acréscimos','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(0.6,4,'','',0,'',0);
		$this->SetFont('Arial','B',6);
		$this->Cell(106.2,-2,$Instrucoes[7],'',0,'L',0);
		$this->SetFont('Arial','B',5.5);
		$this->Cell(7.9,4,'','',0,'L',0);
		$this->Cell(0.7,4,'','',0,'',1);
		$this->SetFillColor(255,255,255);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.6,3,'',0,0,'',0);
		$this->Cell(106.2,-3,$Instrucoes[8],0,0,'L',0);	
		$this->Cell(7.9,3,'',0,0,'L',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,4,'(=) Valor cobrado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,'Sacado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,4,'',0,0,'',1);
		$this->Cell(148.4,3,$dadosboleto["endereco1"],0,0,'L',0);
		$this->Cell(3,3.5,'','',0,'',0);
		...
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,5.5,$sacado1,'LR',0,'L',0);
		$this->SetFillColor(0,0,0);

		$this->SetY($posY+70.5);
		$this->SetFont('Arial','',5.5);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,2.5,$sacado2,'',0,'L',0);
		
		$this->Ln();
		$this->Cell(33.5,0.1,'','LRB',0,'L',0);
