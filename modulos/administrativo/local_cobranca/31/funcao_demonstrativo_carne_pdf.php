...
$height = 0;
	...
	// Reaviso
	include($Path."modulos/administrativo/local_cobranca/31/reaviso_pdf_simples.php");

	// Destinatario	
	include($Path."modulos/administrativo/local_cobranca/31/destinatario_pdf_simples.php");
?>