...
class Boleta extends FPDF
{
	function Cabecalho($IdLoja, $con){
		global $Path;
		include($Path."modulos/administrativo/local_cobranca/31/funcao_cabecalho_pdf.php");
	}
	
	function Demonstrativo($IdLoja, $IdContaReceber, $con){
		global $Path;
		include($Path."modulos/administrativo/local_cobranca/31/funcao_demonstrativo_pdf.php");
	}

	function DemonstrativoCarnePersonalizado($IdLoja, $IdCarne, $con){
		global $Path;
		include($Path."modulos/administrativo/local_cobranca/31/funcao_demonstrativo_carne_pdf.php");
	}
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/31/";
		}

	    $this->Image($PatchImagens."imagens/banco_itau.jpg",11,($posTemp + 0.5),26,5,jpg);
		$this->Cell(40,6,'','T');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','T',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,$codigobanco,'T',0,'C',0);
		$this->Cell(0.4,6,'','T',0,'',1);
		...
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(37,2.5,$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/banco_itau.jpg",11,($posTemp + 37.5),26,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,$codigobanco,'',0,'C',0);
		$this->Cell(0.4,6,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(139.4,2.5,'Pagável em qualquer Banco',0,0,'L',0);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(46.9,2.5,$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(3,2.5,'','',0,'',0);
		...
		$this->Cell(0.5,2.5,'',0,0,'',1);
		$this->Cell(23.1,2.5,$dadosboleto["especie"],0,0,'C',0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
	...
	*/
	...
	//	Image(string file , float x , float y , float w , float h , string type , mixed link)
	    ...
	    $this->Image($PatchImagens."imagens/banco_itau.jpg",50,$posTemp,19.5,5,jpg);
		$this->Cell(65,6.5,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6.5,'','',0,'',1);
		$this->SetFont('Arial','B',10);
		$this->Cell(15,6.5,$codigobanco,'',0,'C',0);
		$this->Cell(0.4,6.5,'','',0,'',1);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,3,'',0,0,'',1);
		$this->Cell(114.5,3,'Pagável em qualquer Banco até o vencimento',0,0,'L',0);
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(33.5,3,$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"],0,0,'R',0);
		$this->Cell(3,3,'','',0,'',0);
		...
		$this->Cell(0.5,3,'',0,0,'',1);
		$this->Cell(17,3,$dadosboleto["especie"],0,0,'C',0);
		$this->Cell(0.4,3,'',0,0,'',1);
		...
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,3,$dadosboleto["agencia"]."/".$dadosboleto["conta"]."-".$dadosboleto["contadigito"],'LR',0,'R',0);
		$this->SetFillColor(0,0,0);
		...
		$this->Cell(148.4,1.5,$dadosboleto["sacado"],0,0,'L',0);
		$this->Cell(3,3.0,'','',0,'',0);
		...
		$this->Cell(148.4,-0.5,$dadosboleto["endereco1"],0,0,'L',0);
		...
		$this->Cell(148.4,-2.8,$dadosboleto["endereco2"],0,2,'L',0);
		$this->Cell(148.4,4.9,"",'B',0,'L',0);
		$this->Cell(3,4.9,'','B',0,'',0);
		
		// L24 - Codigo de Barras		
		$this->Ln();
		$this->SetFont('Arial','',7);
		$this->SetFillColor(0,0,0);
		$this->Cell(33.5,5.5,'Sacado','LRT',0,'L',0);
		$this->SetFillColor(0,0,0);
