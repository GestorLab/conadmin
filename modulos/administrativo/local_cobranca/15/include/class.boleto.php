...
class Boleta extends FPDF
{
	...
	function Titulo($IdLoja, $IdContaReceber, $con){
		...
		$dadosboleto["codigo_cedente"]			= $CobrancaParametro[CodigoCedente]; 
		...
		// L1
		if($Background == 's'){
			$PatchImagens = $Path."/modulos/administrativo/local_cobranca/15/";
		}

	    $this->Image($PatchImagens."imagens/logosicredi.jpg",11,($posTemp+0.5),38.5,5,jpg);
		$this->Cell(40,6,'','T');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','T',0,'',1);
		$this->SetFont('Arial','B',12);
		$this->Cell(20,6,'748-X','T',0,'C',0);
		$this->Cell(0.4,6,'','T',0,'',1);
		...
		// L11
		$this->Ln();
	    $this->Image($PatchImagens."imagens/logosicredi.jpg",11,($posTemp + 37.5),38.5,5,jpg);
		$this->Cell(40,6,'','');
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,6,'','',0,'',1);
		$this->SetFont('Arial','B',12);
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(0.4,2.5,'',0,0,'',1);
		$this->Cell(139.4,2.5,$CobrancaParametro[LocalPagamento],0,0,'L',0);
	...
	function RemetenteDestinario($IdLoja, $IdContaReceber, $con){
		global $Path;
		global $Background;
		global $ExtLogoPDF;
		...
		$this->Image($logo,155,5,$dadosImgLargura,$dadosImgAltura,jpg);

		$this->SetFont('Arial','B',10);
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,'REMENTENTE:','',0,'L',0);		
		$this->Ln();
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,"$dadosboleto[cedenteTit] ($dadosboleto[cedente])",'',0,'L',0);
			
		$this->Ln();
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["endereco"],'',0,'L',0);
		
		$this->Ln();
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["cidade"],'',0,'L',0);
		...
		if($Background == 's'){
			$sicredi_logo = $Path."modulos/administrativo/local_cobranca/15/imagens/sicredi_logo.jpg";
		}else{
			$sicredi_logo = "imagens/sicredi_logo.jpg";
		}

		$dadosImg			= getimagesize($sicredi_logo);
		$dadosImgLargura	= ($dadosImg[0]/$divisor);
		$dadosImgAltura		= ($dadosImg[1]/$divisor);

		$this->Image($sicredi_logo,163,$PosTop,$dadosImgLargura,$dadosImgAltura,jpg);

		$this->SetFont('Arial','B',11);
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,'DESTINATÁRIO:','',0,'L',0);
		$this->Ln();
		...
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["nome_sacado"],'',0,'L',0);
		
		if($dadosboleto["representante"] != '' && $dadosboleto["representante"] != $dadosboleto["nome_sacado"]){
			$this->Ln();
			$this->SetFillColor(0,0,0);
			$this->Cell(30,5,'','',0,'',0);
			$this->Cell(105,5,$dadosboleto["representante"],'',0,'L',0);
		}
		
		$this->Ln();
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["endereco01"],'',0,'L',0);
		
		$this->Ln();
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["endereco02"],'',0,'L',0);
		
		$this->Ln();
		$this->SetFillColor(0,0,0);
		$this->Cell(30,5,'','',0,'',0);
		$this->Cell(105,5,$dadosboleto["endereco03"],'',0,'L',0);
