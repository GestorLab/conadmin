<?
	$IdLocalCobrancaLayout = 32;
	$EndFile 	= "modulos/administrativo/local_cobranca/32/pdf_all.php";
	$Vars 		= $_SERVER['argv'];
	...
	if($Background == 's'){
		...
		require($Path."modulos/administrativo/local_cobranca/32/include/class.boleto.php");
		require($Path."modulos/administrativo/local_cobranca/32/include/funcoes_cef_sigcb.php");
