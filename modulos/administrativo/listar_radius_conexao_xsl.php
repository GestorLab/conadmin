<?
	...
	$localDiaReferencia			= $_GET['DiaReferencia'];
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/radius_conexao.js'></script>
	</head>
	<body  onLoad="ativaNome('Radius/Relatório de Utilização')">
		<? include('filtro_radius_conexao.php'); ?>
