<?
	...
	if($filtro_mes_cadastro!=""){
		...
		$filtro_sql .= " and (subString(Contrato.DataCriacao,1,7) like '$filtro_mes_cadastro')";
	}
	...
	if($filtro_sql!=""){
		$filtro_sql .= " and Contrato.IdAgenteAutorizado!=''";
	}
	...
	*/
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_agente_autorizado_xsl.php$filtro_url\"?>";
	echo "<db>";
