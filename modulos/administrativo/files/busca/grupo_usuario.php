			<div id='quadroBuscaGrupoUsuario' style='width:365px;' class='quadroFlutuante'>	
				...
				<table class='titMenu' cellspacing='0' cellpading='0'>
					<tr>
						<td class='tit'>Busca Grupo Usuário</td>
						<td class='fecha' onClick="vi_id('quadroBuscaGrupoUsuario', false);">X</div></td>
					</tr>
				</table>
				<div class='filtro_busca'>
					...
					<script>
								...
								if(xmlhttp.readyState == 4){ 
									if(xmlhttp.status == 200){
										if(xmlhttp.responseText == 'false'){
											document.getElementById('listaDadosQuadroGrupoUsuario').innerHTML = "";
											// Fim de Carregando
											carregando(false);
										}else{
						...
						enterAsTab(document.forms.formularioGrupoUsuario);	
					</script>
				</div>
			</div>
