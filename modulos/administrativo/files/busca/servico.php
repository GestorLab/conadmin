				...
				<div class='filtro_busca'>
					<form name='formularioServico' method='post'>
						<table>
							...
							<tr>
								<td class='campo'>
									<input type='text' name='DescricaoServico' autocomplete="off" value='' style='width:252px' maxlength='100' onkeyup="busca_servico_lista()" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" tabindex='1'>
								</td>
								<td class='campo'>
								...
								<td class='campo'>
									<select name='IdTipoServico' style='width:95px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onChange="busca_servico_lista()">
										<option value=''>Todos</option>
										<?
											$sql = "select 
														IdParametroSistema, 
					...
					<script>
						...
						function busca_servico_lista(){					
							...
							var IdTipoServico	 		= document.formularioServico.IdTipoServico.value;
						    ...
						    if(DescricaoServico == '' && IdTipoServico == '' && IdServicoGrupo == ''){						    	
							...
							if(Local == 'ServicoParametroNotaFiscal'){
								url+= "&IdNotaFiscalTipo=1";
							}
						...
						function aciona_busca_servico(campo,valor){
							var camp = document.getElementById('listaDados_td_'+valorCampoServico);
							if(valorCampoServico != '' && camp != undefined){
								camp.style.backgroundColor = "#FFFFFF";
							}
							if(document.BuscaServico.Local.value != ""){
								var Local	= document.BuscaServico.Local.value;	
							}else{
