			<div id='quadroBuscaEstado' style='width:365px;' class='quadroFlutuante'>
				<table class='titMenu' cellspacing='0' cellpading='0'>
					<tr>
						...
						<td class='fecha' onClick="vi_id('quadroBuscaEstado', false);">X</div></td>
					</tr>
				</table>
					...
					<script language='JavaScript' type='text/javascript'>
							...
							if(valorCampoEstado !=''){
								for(i=0;i<document.formulario.length;i++){
									if(document.formulario[i].name.substr(0,7) == 'IdPais_'){
										...
										if(temp[1] == document.BuscaEstado.Endereco.value){
											IdPais	=	document.formulario[i].value;
											break;
										}
									}
								}
								busca_pessoa_estado(IdPais,valorCampoEstado,false,document.formulario.Local.value,document.BuscaEstado.Endereco.value);
							}
							return false;
						}
						...
						function aciona_busca_estado(campo,valor){	
							...
							if(valorCampoEstado == valor){
								busca_pessoa_estado(IdPais,valor,false,document.formulario.Local.value,document.BuscaEstado.Endereco.value);
							}
