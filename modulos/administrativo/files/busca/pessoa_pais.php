				...
				<div class='filtro_busca'>
					...
					<script language='JavaScript' type='text/javascript'>
						...
						function validar_busca_pais(){
							if(valorCampoPais !=''){
								busca_pessoa_pais(valorCampoPais,false,document.formulario.Local.value,document.BuscaPais.Endereco.value);	
							}
							return false;
						}
						...
						function aciona_busca_pais(campo,valor){
							...
							if(valorCampoPais == valor){
								busca_pessoa_pais(valor,false,document.formulario.Local.value,document.BuscaPais.Endereco.value);
							}
