			<div id='quadroBuscaCFOP' style='width:533px;' class='quadroFlutuante'>	
					...
					<form name='formularioCFOP' method='post'>
						<table>
							...
							<tr>
								...
								<td class='campo'>
									<input type='text' name='Nome' autocomplete="off" value='' style='width:423px' maxlength='255' onkeyup="busca_cfop_lista()" onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')">
								</td>
							</tr>
						</table>
					</form>
