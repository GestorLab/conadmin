				...
				<div class='filtro_busca'>
					<form name='formularioProcessoFinanceiro' method='post'>
						<table>
							...
							<tr>
								...
								<td  class='campo'>
								<select name='IdStatus' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" style='width:125px' onChange="busca_processo_financeiro_lista()" tabindex='3'>
					...
					<script>
						...
						function busca_processo_financeiro_lista(){
							...
							var IdStatus		= document.formularioProcessoFinanceiro.IdStatus.value;
