				...
				<div class='filtro_busca'>
					...
					<script>
						...
						function busca_servico_lista(){
						    ...
						    if(DescricaoServico == '' && IdServicoGrupo == '' && document.formulario.IdContrato.value == ""){
						    	url = "xml/servico.php?Limit="+Limit+"&Local="+Local+"&IdTipoServico="+IdTipoServico;
							}else{
								url = "xml/servico.php?DescricaoServico="+DescricaoServico+"&Local="+Local+"&IdTipoServico="+IdTipoServico+"&IdServicoGrupo="+IdServicoGrupo+"&IdContrato="+document.formulario.IdContrato.value;
							}							
