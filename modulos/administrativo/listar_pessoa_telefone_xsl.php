...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/pessoa_telefone.js'></script>
	</head>
	<body onLoad="javascript:ativaNome('Pessoa/Telefones');"> 
		<? include("filtro_pessoa_telefone.php"); ?>
		...
		<div id='conteudo'>	
			<table class='tableListar' id='tableListar' cellspacing='0'>
				<tr class='tableListarTitle'>
					...
					?>
					<td>
						<a href="javascript:filtro_ordenar('Telefone1');"><?=dicionario(215)?>. <?=compara($localOrdem,"Telefone1",$ImgOrdernarASC,'');?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('Telefone2');"><?=dicionario(216)?>. (1) <?=compara($localOrdem,"Telefone2",$ImgOrdernarASC,'');?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('Telefone3');"><?=dicionario(216)?>. (2) <?=compara($localOrdem,"Telefone3",$ImgOrdernarASC,'');?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('Celular');"><?=dicionario(100)?><?=compara($localOrdem,"Celular",$ImgOrdernarASC,'');?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('Fax');"><?=dicionario(101)?><?=compara($localOrdem,"Fax",$ImgOrdernarASC,'');?></a>
					</td>
					<td class='bt_lista' />
				</tr>
