<?
	...
	$localOcultaPrioridade	= $_GET['OcultaPrioridade'];
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				<tr class='tableListarTitle'>
					...
					<?
						if($filtro_oculta_prioridade == 2){
							echo"<td>
								<a href=\"javascript:filtro_ordenar('IdPrioridade','number')\">Prioridade ".compara($localOrdem,"IdPrioridade",$ImgOrdernarASC,'')."</a>
							</td>";
						}	
					?>
					<td>
