<?
	...
	$filtro_valor_parametro		= $_POST['filtro_valor_parametro'];
	...
	if($filtro_cancelado != ""){
		...
		if($filtro_status == ""){
			if($filtro_cancelado == 2){
				$filtro_sql  .= " and (Contrato.IdStatus > 199)";
			}
		}
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_sem_cobranca_aberto_xsl.php$filtro_url\"?>";
	echo "<db>";
				...
				where
				    ...
				    Contrato.IdContrato not in (
						...
						where 
							...
							IdStatus = 1 and 
							IdStatusContaReceber != 0 and 
							IdStatusContaReceber != 2 and 
							IdStatusContaReceber != 7
					)
					$filtro_sql	
				order by
