...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_contrato.php'>
						...
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									...
									<td><select name='filtro_local_cobranca_avancado' style='width:185px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
												$sql = "select 
															IdLocalCobranca,
												...
												while($lin = mysql_fetch_array($res)){
													...
													echo "<option value='$lin[IdLocalCobranca]' ".compara($IdLocalCobrancaAvancado,$lin[IdLocalCobranca],"selected='selected'","").">$lin[DescricaoLocalCobranca]</option>";
												}
											?>
										</select>
									</td>
								...
								<tr>
									...
									<td>
										<select name='filtro_parametro_aproximidade' style='width:105px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'  onChange="atualizaSessao(this.name,this.value)">
											<?
												$sql = "select IdParametroSistema, ValorParametroSistema from ParametroSistema where IdGrupoParametroSistema=106 order by ValorParametroSistema";
												$res = @mysql_query($sql,$con);
												while($lin = @mysql_fetch_array($res)){
								...
								<tr>
									...
									<td>
										<select name='filtro_tipo' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" style='width:105px' onKeyDown='listar(event)'>
											<option value=''><?=dicionario(153)?></option>
											<?
