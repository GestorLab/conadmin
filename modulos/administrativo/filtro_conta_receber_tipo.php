...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_conta_receber_tipo.php'>
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name='filtro_tipo_lancamento' style='width:108px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'>
							...
							<?
								...
								while($lin = @mysql_fetch_array($res)){
									echo"<option value='$lin[IdParametroSistema]' ".compara($localIdTipoLancamento,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
								}
							?>
						</select>
					</td>
					<td>
						<select name='filtro_local_cobranca' style='width:70px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')"  onKeyDown='listar(event)'>
							<option value=''>Todos</option>
							<?
					...
					<td><input type='text' name='filtro_valor' value='<?=$localValor?>' style='width:77px' maxlength='100' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onkeypress="chama_mascara(this,event)" onKeyDown="listar(event);" /></td>
					<td>
						<select name='filtro_status' style='width:134px'  onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown='listar(event)'>
							<option value=''>Todos</option>
							<?
