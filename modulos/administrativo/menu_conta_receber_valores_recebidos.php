<?
	...
	$array_operacao = array(  "17", "77", "78", "69", "47", "79", "80", "59", "60", "61", "92","131");	
...
<html>	
	<head>
		...
		<script type = 'text/javascript' src = 'js/conta_receber_valores_recebidos.js'></script>
	</head>
	<body onLoad="ativaNome('Contas a Receber/Valores Recebidos')">
		<? include('filtro_conta_receber_valores_recebidos.php'); ?>
	</body>
</html>
