<?
	...
	//array( Ticket, Login e Data de Criação, Conteúdo Histórico, Usuário Atendimento, Pendente Atualização - Reincidente, Ano, Mês, Usuário Atendimento Mês, Previsão
	$array_operacao = array(  "65", "124", "139", "146", "147", "148", "149", "150", "161") ;	
...
<html>	
	...
	<body  onLoad="ativaNome('Help Desk/Pesquisa Avançada')">
		<div id='filtroBuscar'>
			<form name='filtro' method='post' action='listar_help_desk_opcoes.php'>
