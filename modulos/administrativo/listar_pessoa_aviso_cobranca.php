<?
	...
	$filtro_pessoa_situacao_cadastro	= $_POST["filtro_pessoa_situacao_cadastro"];
	$filtro_status_contrato				= $_POST['filtro_status_contrato'];
	$filtro_local_cobranca_avancado		= $_POST['filtro_local_cobranca_avancado'];
	$filtro_pessoa_forma_cobranca		= $_POST['filtro_pessoa_forma_cobranca'];
	
	$filtro_url	= "";
	$filtro_sql = "";
	$filtro_from_contrato_contrato = "";
	...
	if($filtro_status_contrato != ""){
		$filtro_from_contrato = ",Contrato";
		$filtro_url	.= "&StatusContrato=$filtro_status_contrato";
		$aux	=	explode("G_",$filtro_status_contrato);
		$filtro_sql .= " and Contrato.IdPessoa = Pessoa.IdPessoa 
						and Contrato.IdLoja = 1 
						and Contrato.IdPessoa = Pessoa.IdPessoa ";
		if($aux[1]!=""){
			switch($aux[1]){
				case '1':
					$filtro_sql .= " and Pessoa.IdPessoa = Contrato.IdPessoa and (Contrato.IdStatus >= 1 and Contrato.IdStatus < 100)";
					break;
				case '2':
	...
	if($filtro_local_cobranca_avancado!=''){
		$filtro_url .= "&IdLocalCobrancaAvancado=".$filtro_local_cobranca_avancado;
		$filtro_sql .= " and (Contrato.IdLocalCobranca = '$filtro_local_cobranca_avancado')";
		$filtro_sql .= " and Pessoa.IdPessoa = Contrato.IdPessoa";
		$filtro_from_contrato = ",Contrato";
	}	
	if($filtro_pessoa_situacao_cadastro != ''){
		$filtro_url	.= "&ExibirClientes=$filtro_pessoa_situacao_cadastro";
	}
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_pessoa_aviso_cobranca_xsl.php$filtro_url\"?>";
	echo "<db>";
