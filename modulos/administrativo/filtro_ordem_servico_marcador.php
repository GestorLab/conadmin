	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='menu_ordem_servico_marcador.php'>
			<table>
				<tr>
	...
	<div class='graficos' style='text-align:center'>
		<BR><BR><img src='graficos/ordem_servico_marcador.php?IdGrupoUsuarioAtendimento=<?=$IdGrupoUsuarioAtendimento?>&IdTipoOrdemServico=<?=$IdTipoOrdemServico?>&IdSubTipoOrdemServico=<?=$IdSubTipoOrdemServico?>' />
	</div>
