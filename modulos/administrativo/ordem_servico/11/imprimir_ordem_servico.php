	...
	$Impress	=	"<HTML>
			...
			<BODY>
				<div id='conteudo'>
					...
					if($lin[Obs] != ''){
						$caracter = array("\r\n", "\n", "\r");
						$lin[Obs] = str_replace($caracter, "<br />", $lin[Obs]);
						
						$Impress.="
							</td>
						</tr>
					</table>
					<table style='width:100%; border-top:1px #000 solid;' cellspacing='0' cellpadding='0'>
						<tr>
							<td class='lateral'>H<BR>I<BR>S<BR>T<BR>Ó<BR>R<BR>I<BR>C<BR>O</td>
							<td valign='top' style='margin:0; padding:0'>
							<div style='margin:3px 0 0 5px'>$lin[Obs]</div>";
					}
