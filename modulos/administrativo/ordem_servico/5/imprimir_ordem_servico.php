								...
								<table style='width:100%; margin: 10px 0 0 0; border-top:1px #000 solid'  cellspacing='0'  cellpading='0'>
									<tr>
										<td style='width:50%; margin:0; border-right:1px #000 solid;'>
											<B style='margin-top:5px'>Data:</B>___ /___ /______&nbsp;___:___ às ___:___ &nbsp;
								    ...
								    <tr>
										<td>
											<span style='font-family: 'Courier New', Courier;'>
												!! Importante: Todos os materiais e equipamentos aqui utilizados são de
												propriedade exclusiva de nossa empresa e devem ser devolvidos no caso de
												rompimento do contrato em vigor.

												Declaro estar recebendo e aprovando os serviços e equipamentos utilizados 
												nesta ordem de serviço em perfeitas condições de funcionamento e dentro das
												especificações acima descritas, conforme contrato em vigor. Declaro ainda,
												que não ocorreram outros problemas de interferências.
											</span>";
											if($lin[IdTipoOrdemServico] == 1){
												$Impress.="
