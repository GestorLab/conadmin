<?
	...
	$Impress	=	"<HTML>
			<HEAD>
				...
				<style type='text/css'>
					body{	margin:0; padding:5px;	font: normal 10.1px Courrier, Arial, Times;	}
					p{ 	margin:0 0 1px 0; }
					table{ width:99%;	}	
					table .lateral{	width: 15px; padding: 0; border-right:1px #000 solid; text-align:center; }
					table tr td{	font: normal 10.1px Courrier, Arial, Times; margin:0; padding-left:5px;	}
				...
				<div id='conteudo'>
					<table style='width:100%;' cellspacing='0' cellpading='0'>
						<tr>
							...
							<td style='border-right:1px #000 solid; text-align:center;'><div><h1 style='font-size: 20px;'>OS $local_IdOrdemServico</h1></div></td>
							<td style='width:50%'>
		...
		<HTML>
			<HEAD>
				<style type='text/css'>
					...
					table{ width:99%;	}	
					table .lateral{	width: 15px; padding: 0; border-right:1px #000 solid; text-align:center; }
					table tr td{	font: normal 10.1px Courrier, Courrier, Times; margin:0; padding-left:5px;	}
					h1{	font-size: 20px; font-weight:bold}
