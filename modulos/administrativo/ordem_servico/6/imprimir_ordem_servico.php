				...
				<div id='conteudo'>
						...
						<table style='width:100%; border-top:1px #000 solid;' cellspacing='0' cellpading='0'>
							<tr>
								...
								<td style='font-size:12px;'>";
									if($lin[TipoPessoa]==1){
										if($lin[Nome] ==''){
											$Impress.=" <p style='margin:0; padding-bottom:3px'><B>Razão Social:</B> $lin[RazaoSocial]</p>";
										}else{
											if($lin[RazaoSocial]==''){
												$Impress.=" <p style='margin:0; padding-bottom:3px'><B>Nome Fantasia:</B> $lin[Nome]</p>";
											}
											else{
												$Impress.=" <p style='margin:0; padding-bottom:3px'><B>Nome Fantasia (Razão Social):</B> $lin[Nome]  ($lin[RazaoSocial]) </p>";
											}
										}
									}else{
										$Impress.=" <p style='margin:0; padding-bottom:3px'><B>Nome:</B> $lin[Nome]</p>";
									}
					...
					if($lin[IdServico]!=""){
						...
						<table cellspacing='0' cellpading='0' style='margin-left:-5px'>
							<tr>
								<td style='width:100%' colspan='2'><B>Serviço:</B> [$lin[IdServico]] $lin[DescricaoServico]</td>
								</td>
							</tr>
							<tr>
								<td><B>Valor (".getParametroSistema(5,1)."):</B> $lin[Valor] &nbsp; <B>Outros Valores (".getParametroSistema(5,1)."):</B> $lin[ValorOutros]</td>
								</BR><td><B>Valor Total (".getParametroSistema(5,1)."):</B> $lin[ValorTotal]</td>
							</tr>
						</table>";
