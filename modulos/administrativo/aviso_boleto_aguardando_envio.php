...
<html>
	...
	<body onLoad="ativaNome('Boleto Aguardando Envio')">
		<div id='sem_permissao'>
			<p id='p1' style='margin-left:15px'>Título Aguardando Envio</p>
			<p id='p2' style='margin-left:15px'>Este Título está Aguardando Envio. </br>Caso queira imprimir mesmo assim, clique no botão abaixo para continuar.</p>
			</br>
