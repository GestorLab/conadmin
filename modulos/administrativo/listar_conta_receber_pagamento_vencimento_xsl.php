<?
	...
	$local_Pagamento				= $_GET['Pagamento'];
...
<html>	
	...
	<body  onLoad="ativaNome('<?=dicionario(869)?>')">
		<div id='carregando'><?=dicionario(17)?></div>
		<? include('filtro_conta_receber_pagamento_vencimento.php'); ?>
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				<tr class='tableListarTitle'>
					...
					<td>
						<a href="javascript:filtro_ordenar('MesVencimentoOriginal','number')">Venc. Original<?=compara($localOrdem,"Valor",$ImgOrdernarASC,'')?></a>
					</td>
					<td>
						<a href="javascript:filtro_ordenar('DataVencimento','number')"><?=dicionario(710)?> <?=compara($localOrdem,"DataVencimento",$ImgOrdernarASC,'')?></a>
					</td>
					<td class='valor'>
				...
				<xsl:element name="tr">
					...
					<xsl:element name="td">
						...
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_conta_receber.php?IdContaReceber=<xsl:value-of select="IdContaReceber"/></xsl:attribute>
							<xsl:value-of select="VencimentoOriginal"/>
						</xsl:element>
					</xsl:element>
