...
?>
	<div id='filtroBuscar'>
		<form name='filtro' method='post' action='listar_help_desk.php'>
					...
					<td colspan='7'>
						<div id='filtroRapido' style='width:100%; display:none; background-color: #0065D5'>
							<table style='width:100%;'>
								...
								<tr>
									<td>Ocultar Coluna Prioridade</td>
									<td>
										<select name='filtro_oculta_prioridade' style='width: 81px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onChange="atualizaSessao(this.name,this.value)" onKeyDown='listar(event)'>
											<?
												...
												while($lin = @mysql_fetch_array($res)){
													...
													echo"<option value='$lin[IdParametroSistema]' ".compara($filtro_oculta_prioridade,$lin[IdParametroSistema],"selected='selected'","").">$lin[ValorParametroSistema]</option>";
												}
											?>
										</select>	
									</td>
								...
								<tr>
									<td style='width:181px'>Prioridade</td>
									<td>
										<select name='filtro_prioridade' style='width:181px' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" onKeyDown='listar(event)'>
											<option value=''>Todos</option>
											<?
