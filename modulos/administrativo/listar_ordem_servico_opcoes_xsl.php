<?
	...
	//array(Ordem de Serviço, Ordem Serviço/Agendamento, Ordem de Serviço/Data, Ordem Serviço/Lote Repasse Ter,Ordem Serviço/Lote Repasse Ter, Ordem Servico/Localidade, Ordem de Servico/Tipo Pessoa, Ordem de Serviço/Marcador, Ordem Serviço/Serviço);
	$array_operacao = array(  "26", "91", "116", "132", "134", "156","163", "191", "192") ;	
...
<html>	
	...
	<body  onLoad="ativaNome('Ordem Serviço/Pesquisa Avançada')">
		<div id='filtroBuscar'>
			<form name='filtro' method='post' action='listar_ordem_servico_opcoes.php'>
