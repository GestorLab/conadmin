<?
	...
	$local_DescricaoTipo				= formatText($_POST['DescricaoTipo'],NULL);
	...
	switch ($local_Acao){
		case 'inserir':
			include('files/inserir/inserir_tipo_help_desk.php');
			break;
			
		case 'alterar':
			include('files/editar/editar_tipo_help_desk.php');
			break;
...
<html>
	...
	<body onLoad="ativaNome('Tipo Help Desk')">
		...
		<div id='conteudo'>
			<form name='formulario' method='post' action='cadastro_tipo_help_desk.php' onSubmit='return validar()'>
				<input type='hidden' name='Acao' value='<?=$local_Acao?>'>
				<input type='hidden' name='Erro' value=<?=$local_Erro?>>
				<input type='hidden' name='Local' value='TipoHelpDesk'>
				<div>
					<table>
						<tr>
							<td class='find'>&nbsp;</td>
						...
						<tr>
							...
							<td class='separador'>&nbsp;</td>
							<td class='campo'>
								<input type='text' name='DescricaoTipo' value='' style='width:613px' maxlength='155' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out');" tabindex='2'>
							</td>
							<td class='separador'>&nbsp;</td>
							<td class='campo' valign='top'>
								<select name='IdStatus' onFocus="Foco(this,'in')" onBlur="Foco(this,'out')" style='width: 106px' onFocus="Foco(this,'in','auto')" onBlur="Foco(this,'out')" tabindex='3'>
									<option value=''></option>
									<?
										$sql = "select
													IdParametroSistema,
					...
					<table style='float:right; margin-right:6px'>
						<tr>
							<td class='campo'>
								...
								<input type='button' name='bt_excluir' value='Excluir' class='botao' tabindex='9' onClick="excluir(document.formulario.IdTipo.value)">
							</td>
						</tr>
					</table>
					<table>
