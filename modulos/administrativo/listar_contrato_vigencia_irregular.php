<?
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_vigencia_irregular_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	$sql	=	"select
				...
				from
				    Loja,
				    Contrato left join ContratoVigenciaAtiva on Contrato.IdContrato = ContratoVigenciaAtiva.IdContrato,
				  	ContratoVigencia,
				    Servico,
				    Pessoa,
				...
				where
					...
					(ContratoVigencia.DataInicio = '0000-00-00' or 
					ContratoVigencia.DataTermino = '0000-00-00' or 
					ContratoVigencia.DataInicio like '0000-%' or 
					ContratoVigencia.DataTermino like '0000-%')	$filtro_sql
				group by
					Contrato.IdContrato 
				order by
	...
	/*$sql	=	"select
				    ...
				    Contrato.IdPessoa,				    
					Pessoa.TipoPessoa,
				    substring(Pessoa.Nome,1,12) Nome,
				    substring(Pessoa.RazaoSocial,1,12) RazaoSocial,
				    Contrato.DataInicio,
				    Contrato.DataTermino,
				    LocalCobranca.AbreviacaoNomeLocalCobranca,
				    (ContratoVigenciaAtiva.Valor - ContratoVigenciaAtiva.ValorDesconto) ValorFinal,
				...
				where
				    ...
				    Contrato.IdPessoa = Pessoa.IdPessoa and
				    Contrato.IdLocalCobranca = LocalCobranca.IdLocalCobranca and
					(Contrato.DataInicio = '0000-00-00' or Contrato.DataTermino = '0000-00-00')	$filtro_sql
				group by
					Contrato.IdContrato
				$Limit"; */
?>
