<?
	...
	$filtro_contrato_ativo		= $_POST['filtro_contrato_ativo'];
	...
	if($filtro_contrato_ativo!=""){
		$filtro_url .= "&ContratoAtivo=".$filtro_contrato_ativo;
		if($filtro_contrato_ativo==2){
	...
	if($filtro_grupo_pessoa!=""){
		...
		$filtro_from .= ", GrupoPessoa,  PessoaGrupoPessoa";
		$filtro_sql .= "and GrupoPessoa.IdGrupoPessoa = $filtro_grupo_pessoa AND PessoaGrupoPessoa.IdGrupoPessoa = GrupoPessoa.IdGrupoPessoa AND Pessoa.IdPessoa = PessoaGrupoPessoa.IdPessoa";
	}
	/*
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_pessoa_dados_cliente_xsl.php$filtro_url\"?>";
	echo "<db>";
