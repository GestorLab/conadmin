<?
	...
	$localData				= $_POST["filtro_data"];
	$localIdPais			= $_POST["filtro_pais"];
	$localIdEstado			= $_POST["filtro_estado"];
	$localIdCidade			= $_POST["filtro_cidade"];
?>
...
<html>	
	...
	<body onLoad="ativaNome('<?=dicionario(366)?>')">
		<? include('filtro_contrato_status.php'); ?>
		<br /><br />
