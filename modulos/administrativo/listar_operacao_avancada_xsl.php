...
<html>	
	...
	<body  onLoad="ativaNome('Operações Avançadas')">
		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>
				<tr class='tableListarTitle'>
					<td class='id_listar' />
					<td>
						<a href="javascript:filtro_ordenar('Operacao','text')">Operações Avançadas<?=compara($localOrdem,"Operacao",$imgOrdernarASC,'')?></a>
					</td>
				</tr>
