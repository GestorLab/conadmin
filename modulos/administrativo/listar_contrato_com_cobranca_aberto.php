<?
	...
	*/
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_contrato_com_cobranca_aberto_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	$sql	=	"select
				...
				from
				    ...
				    Pessoa,
				    LocalCobranca,
					ContratoVigenciaAtiva $filtro_from $sqlAux
				where
				    ...
				    Contrato.IdContrato in (select distinct IdContrato from LancamentoFinanceiroDados where IdLoja = $local_IdLoja and IdContrato != '' and IdOrdemServico is null and IdContaEventual is null and IdStatus = 1 and IdStatusContaReceber != 0 and IdStatusContaReceber != 2 and IdStatusContaReceber != 7)
					$filtro_sql	
				order by
