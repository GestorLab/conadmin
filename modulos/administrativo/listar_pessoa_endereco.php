<?
	...
	echo "<?xml-stylesheet type=\"text/xsl\" href=\"listar_pessoa_endereco_xsl.php$filtro_url\"?>";
	echo "<db>";
	...
	while($lin	=	mysql_fetch_array($res)){
		...
		*/
		...
		while($lin3 = mysql_fetch_array($res3)){
			...
			if($lin3["Endereco"] != "")
			$endereco = $lin3["Endereco"];

			if($lin3["Numero"] != "")
			$endereco .= ", n° ".$lin3["Numero"];
			
			if($lin3["Bairro"] != "")
			$endereco .= ", Bairro: ".$lin3["Bairro"];
			
			if($lin3["Complemento"] != "")
			$endereco .= ", ".$lin3["Complemento"];
			
			echo 	"<EnderecoEncontrado>";
			echo 	"<IdPessoa><![CDATA[$lin3[IdPessoa]]]></IdPessoa>";
