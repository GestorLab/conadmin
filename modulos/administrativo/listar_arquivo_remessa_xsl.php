		...
		<div id='conteudo'>
			<table class='tableListar' cellspacing='0' Id='tableListar'>					
				...
				<xsl:element name="tr">
					...
					<td>
						<xsl:element name="a">
							<xsl:attribute name="href">cadastro_arquivo_remessa.php?IdLocalCobranca=<xsl:value-of select="IdLocalCobranca"/>&amp;IdArquivoRemessa=<xsl:value-of select="IdArquivoRemessa"/></xsl:attribute>
