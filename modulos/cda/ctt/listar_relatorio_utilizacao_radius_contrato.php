													...
													if(@mysql_num_rows($res) >=1){
														while($lin	=	@mysql_fetch_array($res)){
															...
															<tr>
																...
																if($lin[Usuario] != ""){
																	echo"<a href='menu.php?ctt=listar_relatorio_utilizacao_radius.php&IdContrato=$lin[IdContrato]&IdParametroSistema=$local_IdParametroSistema' target='_blank' style='color:#C10000;'>Visualizar Relatório</a>";
																}																
															echo"</TD>
															</tr>
															";
