		...
		<form name='filtro' method='post' action='listar_help_desk.php'>
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name='filtro_tipo' style='width:121px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onChange="alualizar_filtro_subtipo_help_desk(this.value)" onKeyDown='listar(event)'>
					...
					<td>
						<select name='filtro_sub_tipo' style='width:121px' onFocus="Foco(this,'in')"  onBlur="Foco(this,'out')" onKeyDown='listar(event)'>
							<option value=''>Todos</option>
						</select>
					</td>
