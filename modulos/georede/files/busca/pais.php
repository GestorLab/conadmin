			<div id='quadroBuscaPais' style='width:365px;' class='quadroFlutuante'>
				<!--div class='tit'>Busca Paí³¼div class='fecha' onClick="vi_id('quadroBuscaPais', false);">X</div></div-->
				
				<table class='titMenu' cellpadding="0" cellspacing='0'>
					<tr>
						<td class='tit'>Busca País</td>
						<td class='fecha' onClick="vi_id('quadroBuscaPais', false);">X</td>
					</tr>
				</table>
